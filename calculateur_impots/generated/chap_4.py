...
# Original files are "chap-4.json" and "chap-4.m"
...
ACP3 = max(0, somme((min(arr(CHENF(a) * TX_DPAEAV / 100), SEUIL_AVMAXETU) for a in interval(1, 4))) - ANG3) * 1 - positif(V_CR2 + IPVLOC) * positif(ANG3) * positif(IMPIM3)
...
DOMABDB = max(PLAF_RABDOM - ABADO, 0) * positif(V_EAD) + max(PLAF_RABGUY - ABAGU, 0) * positif(V_EAG)


DOMDOM = max(DOMAVTO - DOMABDB, 0) * positif(V_EAD + V_EAG)


ITP = arr(BPTP2 * TX225 / 100 + BPTPVT * TX19 / 100 + BPTP4 * TX30 / 100 + DOMITPD + DOMITPG + BPTP3 * TX16 / 100 + BPTP40 * TX41 / 100 + DOMDOM * positif(V_EAD + V_EAG) + BPTP18 * TX18 / 100 + BPTPSJ * TX19 / 100 + BPTP24 * TX24 / 100) * 1 - positif(IPVLOC) * 1 - positif(present(TAX1649) + present(RE168))
...
IAD11 = max(0, IDOM11 - DEC11 - RED) * 1 - positif(V_CR2 + IPVLOC) + positif(V_CR2 + IPVLOC) * max(0, IDOM11 - RED) * 1 - positif(RE168 + TAX1649) + positif(RE168 + TAX1649) * IDOM16

IREXITI = present(FLAG_EXIT) * 1 - positif(FLAG_3WBNEG) * abs(NAPTIR - V_NAPTIR3WB) + positif(FLAG_3WBNEG) * abs(NAPTIR + V_NAPTIR3WB) * positif(present(PVIMPOS) + present(CODRWB)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


IREXITS = 1 - positif(FLAG_3WANEG) * abs(V_NAPTIR3WA + V_NAPTIR3WB * positif(FLAG_3WBNEG) - V_NAPTIR3WB * 1 - positif(FLAG_3WBNEG)) + positif(FLAG_3WANEG) * abs(V_NAPTIR3WA + V_NAPTIR3WB * positif(FLAG_3WBNEG) - V_NAPTIR3WB * 1 - positif(FLAG_3WBNEG)) * positif(present(PVIMPOS) + present(CODRWB)) + 1 - positif(FLAG_3WANEG) * abs(V_NAPTIR3WA - NAPTIR) + positif(FLAG_3WANEG) * abs(V_NAPTIR3WA - NAPTIR) * 1 - positif(present(PVIMPOS) + present(CODRWB)) * present(FLAG_EXIT) * positif(present(PVSURSI) + present(CODRWA)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


IREXIT = IREXITI + IREXITS


EXITTAX3 = positif(FLAG_3WBNEG) * -1 * V_NAPTIR3WB + 1 - positif(FLAG_3WBNEG) * V_NAPTIR3WB * positif(present(PVIMPOS) + present(CODRWB)) + NAPTIR * positif(present(PVSURSI) + present(CODRWA)) * 1 - positif(present(PVIMPOS) + present(CODRWB)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
IAD31 = IDOM31 - DEC31 * 1 - positif(V_CR2 + IPVLOC) + positif(V_CR2 + IPVLOC) * IDOM31


IAD32 = IDOM32 - DEC32 * 1 - positif(V_CR2 + IPVLOC) + positif(V_CR2 + IPVLOC) * IDOM32
...
def DEC3(z):
    if z in (1, 2):
        return min(max(arr(SEUIL_DECOTE1 * 1 - BOOL_0AM + SEUIL_DECOTE2 * BOOL_0AM - IDOM3(z)), 0), IDOM3(z)) * 1 - V_ANC_BAR + min(max(arr(SEUIL_DECOTEA / 2 - IDOM3(z) / 2), 0), IDOM3(z)) * V_ANC_BAR * 1 - V_CNR
    else:
...
def DEC1(z):
    if z in (1, 2):
        return min(max(arr(SEUIL_DECOTE1 * 1 - BOOL_0AM + SEUIL_DECOTE2 * BOOL_0AM - IDOM1(z)), 0), IDOM1(z)) * 1 - V_ANC_BAR + min(max(arr(SEUIL_DECOTEA / 2 - IDOM1(z) / 2), 0), IDOM1(z)) * V_ANC_BAR * 1 - V_CNR
    else:
        raise NotImplementedError()
...
RCEL_HM = positif(CELLIERHM) * arr(ACELHM * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HM_R = positif(CELLIERHM) * arr(ACELHM_R * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HL = positif(CELLIERHL) * arr(ACELHL * TX25 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HL_R = positif(CELLIERHL) * arr(ACELHL_R * TX25 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HNO = positif(CELLIERHN) * arr(ACELHNO * TX25 / 100) + positif(CELLIERHO) * arr(ACELHNO * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HNO_R = positif(CELLIERHN) * arr(ACELHNO_R * TX25 / 100) + positif(CELLIERHO) * arr(ACELHNO_R * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HJK = positif(CELLIERHJ) * arr(ACELHJK * TX25 / 100) + positif(CELLIERHK) * arr(ACELHJK * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_HJK_R = positif(CELLIERHJ) * arr(ACELHJK_R * TX25 / 100) + positif(CELLIERHK) * arr(ACELHJK_R * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCEL_NBGL = positif(CELLIERNB) * arr(ACELNBGL * TX25 / 100) + positif(CELLIERNG) * arr(ACELNBGL * TX15 / 100) + positif(CELLIERNL) * arr(ACELNBGL * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_NBGL_R = positif(CELLIERNB) * arr(ACELNBGL_R * TX25 / 100) + positif(CELLIERNG) * arr(ACELNBGL_R * TX15 / 100) + positif(CELLIERNL) * arr(ACELNBGL_R * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_COM = positif(CELLIERNP + CELLIERNT) * arr(ACELCOM * TX36 / 100) + positif(CELLIERNR + CELLIERNS) * arr(ACELCOM * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_COM_R = positif(CELLIERNP + CELLIERNT) * arr(ACELCOM_R * TX36 / 100) + positif(CELLIERNR + CELLIERNS) * arr(ACELCOM_R * TX40 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_2011 = positif(CELLIERNA + CELLIERNE) * arr(ACEL * TX22 / 100) + positif(CELLIERNC + CELLIERND + CELLIERNH) * arr(ACEL * TX25 / 100) + positif(CELLIERNF + CELLIERNJ) * arr(ACEL * TX13 / 100) + positif(CELLIERNI) * arr(ACEL * TX15 / 100) + positif(CELLIERNM + CELLIERNN) * arr(ACEL * TX40 / 100) + positif(CELLIERNK + CELLIERNO) * arr(ACEL * TX36 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_2011_R = positif(CELLIERNA + CELLIERNE) * arr(ACEL_R * TX22 / 100) + positif(CELLIERNC + CELLIERND + CELLIERNH) * arr(ACEL_R * TX25 / 100) + positif(CELLIERNF + CELLIERNJ) * arr(ACEL_R * TX13 / 100) + positif(CELLIERNI) * arr(ACEL_R * TX15 / 100) + positif(CELLIERNM + CELLIERNN) * arr(ACEL_R * TX40 / 100) + positif(CELLIERNK + CELLIERNO) * arr(ACEL_R * TX36 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCEL_JBGL = positif(CELLIERJB) * arr(ACELJBGL * TX22 / 100) + positif(CELLIERJG) * arr(ACELJBGL * TX13 / 100) + positif(CELLIERJL) * arr(ACELJBGL * TX36 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_JBGL_R = positif(CELLIERJB) * arr(ACELJBGL_R * TX22 / 100) + positif(CELLIERJG) * arr(ACELJBGL_R * TX13 / 100) + positif(CELLIERJL) * arr(ACELJBGL_R * TX36 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_JOQR = positif(CELLIERJQ) * arr(ACELJOQR * TX36 / 100) + positif(CELLIERJO + CELLIERJR) * arr(ACELJOQR * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_JOQR_R = positif(CELLIERJQ) * arr(ACELJOQR_R * TX36 / 100) + positif(CELLIERJO + CELLIERJR) * arr(ACELJOQR_R * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_2012 = positif(CELLIERJA + CELLIERJE + CELLIERJH) * arr(ACEL2012 * TX13 / 100) + positif(CELLIERJD) * arr(ACEL2012 * TX22 / 100) + positif(CELLIERJF + CELLIERJJ) * arr(ACEL2012 * TX6 / 100) + positif(CELLIERJK + CELLIERJN) * arr(ACEL2012 * TX24 / 100) + positif(CELLIERJM) * arr(ACEL2012 * TX36 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_2012_R = positif(CELLIERJA + CELLIERJE + CELLIERJH) * arr(ACEL2012_R * TX13 / 100) + positif(CELLIERJD) * arr(ACEL2012_R * TX22 / 100) + positif(CELLIERJF + CELLIERJJ) * arr(ACEL2012_R * TX6 / 100) + positif(CELLIERJK + CELLIERJN) * arr(ACEL2012_R * TX24 / 100) + positif(CELLIERJM) * arr(ACEL2012_R * TX36 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_FD = positif(CELLIERFD) * arr(ACELFD * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_FD_R = positif(CELLIERFD) * arr(ACELFD_R * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_FABC = positif(CELLIERFA) * arr(ACELFABC * TX13 / 100) + positif(CELLIERFB) * arr(ACELFABC * TX6 / 100) + positif(CELLIERFC) * arr(ACELFABC * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_FABC_R = positif(CELLIERFA) * arr(ACELFABC_R * TX13 / 100) + positif(CELLIERFB) * arr(ACELFABC_R * TX6 / 100) + positif(CELLIERFC) * arr(ACELFABC_R * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELRREDSOM = somme((RCELRREDL(i)_1 for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) + RCELRREDMG_1 + RCELRREDMH_1
...
RCELREPHF_1 = max(min(ACELREPHF, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPHE_1 = max(min(ACELREPHE, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPHD_1 = max(min(ACELREPHD, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPHH_1 = max(min(ACELREPHH, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPHG_1 = max(min(ACELREPHG, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPHB_1 = max(min(ACELREPHB, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPHA_1 = max(min(ACELREPHA, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGU_1 = max(min(ACELREPGU, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGX_1 = max(min(ACELREPGX, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - RCELREPGU_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGT_1 = max(min(ACELREPGT, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGS_1 = max(min(ACELREPGS, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGW_1 = max(min(ACELREPGW, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGP_1 = max(min(ACELREPGP, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGL_1 = max(min(ACELREPGL, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGV_1 = max(min(ACELREPGV, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGK_1 = max(min(ACELREPGK, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPGJ_1 = max(min(ACELREPGJ, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYH_1 = max(min(ACELREPYH, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYL_1 = max(min(ACELREPYL, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - RCELREPYH_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYG_1 = max(min(ACELREPYG, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYF_1 = max(min(ACELREPYF, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYK_1 = max(min(ACELREPYK, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYE_1 = max(min(ACELREPYE, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYD_1 = max(min(ACELREPYD, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYJ_1 = max(min(ACELREPYJ, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYC_1 = max(min(ACELREPYC, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYB_1 = max(min(ACELREPYB, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYI_1 = max(min(ACELREPYI, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELREPYA_1 = max(min(ACELREPYA, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELHM_1 = max(min(RCEL_HM, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A')))), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELHL_1 = max(min(RCEL_HL, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELHNO_1 = max(min(RCEL_HNO, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELHJK_1 = max(min(RCEL_HJK, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELNQ_1 = max(min(RCEL_NQ, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELNBGL_1 = max(min(RCEL_NBGL, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELCOM_1 = max(min(RCEL_COM, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCELCOM = max(0, RCELCOM_1 * 1 - ART1731BIS + min(RCELCOM_1, max(RCELCOM_P + RCELCOMP2, RCELCOM1731 + 0) * 1 - PREM8_11) * ART1731BIS * 1 - positif(null(CMAJ2 - 8) + null(CMAJ2 - 11))) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RCEL_1 = max(min(RCEL_2011, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELJP_1 = max(min(RCEL_JP, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1 - RCEL_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELJBGL_1 = max(min(RCEL_JBGL, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1 - RCEL_1 - RCELJP_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELJOQR_1 = max(min(RCEL_JOQR, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1 - RCEL_1 - RCELJP_1 - RCELJBGL_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCEL2012_1 = max(min(RCEL_2012, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1 - RCEL_1 - RCELJP_1 - RCELJBGL_1 - RCELJOQR_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELFD_1 = max(min(RCEL_FD, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1 - RCEL_1 - RCELJP_1 - RCELJBGL_1 - RCELJOQR_1 - RCEL2012_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELFABC_1 = max(min(RCEL_FABC, IDOM11 - DEC11 - REDUCAVTCEL - RCELRREDSOM - somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - RCELHM_1 - RCELHL_1 - RCELHNO_1 - RCELHJK_1 - RCELNQ_1 - RCELNBGL_1 - RCELCOM_1 - RCEL_1 - RCELJP_1 - RCELJBGL_1 - RCELJOQR_1 - RCEL2012_1 - RCELFD_1), 0) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RCELTOT = RCELRREDSOM + somme((RCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) + somme((RCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) + somme((RCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) + RCELHM + RCELHL + RCELHNO + RCELHJK + RCELNQ + RCELNBGL + RCELCOM + RCEL + RCELJP + RCELJBGL + RCELJOQR + RCEL2012 + RCELFD + RCELFABC


RCELTOT_1 = RCELRREDSOM + somme((RCELREPH(i)_1 for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) + somme((RCELREPG(i)_1 for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) + somme((RCELREPY(i)_1 for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) + RCELHM_1 + RCELHL_1 + RCELHNO_1 + RCELHJK_1 + RCELNQ_1 + RCELNBGL_1 + RCELCOM_1 + RCEL_1 + RCELJP_1 + RCELJBGL_1 + RCELJOQR_1 + RCEL2012_1 + RCELFD_1 + RCELFABC_1

RIVCELFABC1 = positif(CELLIERFA) * arr(BCEL_FABC * TX13 / 100) + positif(CELLIERFB) * arr(BCEL_FABC * TX6 / 100) + positif(CELLIERFC) * arr(BCEL_FABC * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RIVCELFABC8 = arr(min(CELLIERFA + CELLIERFB + CELLIERFC, LIMCELLIER) * positif(CELLIERFA) * TX13 / 100 + min(CELLIERFA + CELLIERFB + CELLIERFC, LIMCELLIER) * positif(CELLIERFB) * TX6 / 100 + min(CELLIERFA + CELLIERFB + CELLIERFC, LIMCELLIER) * positif(CELLIERFC) * TX24 / 100) - 8 * RIVCELFABC1 * 1 - V_CNR


RIVCELFD1 = positif(CELLIERFD) * arr(BCEL_FD * TX24 / 100) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


RIVCELFD4 = arr(min(CELLIERFD, LIMCELLIER) * positif(CELLIERFD) * TX24 / 100) - 4 * RIVCELFD1 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RIVCEL8 = arr(min(CELSOMN, LIMCELLIER) * positif(CELLIERNM + CELLIERNN) * TX40 / 100 + min(CELSOMN, LIMCELLIER) * positif(CELLIERNK + CELLIERNO) * TX36 / 100 + min(CELSOMN, LIMCELLIER) * positif(CELLIERNC + CELLIERND + CELLIERNH) * TX25 / 100 + min(CELSOMN, LIMCELLIER) * positif(CELLIERNA + CELLIERNE) * TX22 / 100 + min(CELSOMN, LIMCELLIER) * positif(CELLIERNI) * TX15 / 100 + min(CELSOMN, LIMCELLIER) * positif(CELLIERNF + CELLIERNJ) * TX13 / 100) - 8 * RIVCEL1 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RIV2012CEL8 = arr(min(CELSOMJ, LIMCELLIER) * positif(CELLIERJM) * TX36 / 100 + min(CELSOMJ, LIMCELLIER) * positif(CELLIERJK + CELLIERJN) * TX24 / 100 + min(CELSOMJ, LIMCELLIER) * positif(CELLIERJD) * TX22 / 100 + min(CELSOMJ, LIMCELLIER) * positif(CELLIERJA + CELLIERJE + CELLIERJH) * TX13 / 100 + min(CELSOMJ, LIMCELLIER) * positif(CELLIERJF + CELLIERJJ) * TX6 / 100) - 8 * RIV2012CEL1 * 1 - V_CNR
...
RIVCELNBGL8 = arr(min(CELLIERNB + CELLIERNG + CELLIERNL, LIMCELLIER) * positif(CELLIERNB) * TX25 / 100 + min(CELLIERNB + CELLIERNG + CELLIERNL, LIMCELLIER) * positif(CELLIERNG) * TX15 / 100 + min(CELLIERNB + CELLIERNG + CELLIERNL, LIMCELLIER) * positif(CELLIERNL) * TX40 / 100) - 8 * RIVCELNBGL1 * 1 - V_CNR
...
RIVCELJBGL8 = arr(min(CELLIERJB + CELLIERJG + CELLIERJL, LIMCELLIER) * positif(CELLIERJB) * TX22 / 100 + min(CELLIERJB + CELLIERJG + CELLIERJL, LIMCELLIER) * positif(CELLIERJG) * TX13 / 100 + min(CELLIERJB + CELLIERJG + CELLIERJL, LIMCELLIER) * positif(CELLIERJL) * TX36 / 100) - 8 * RIVCELJBGL1 * 1 - V_CNR
...
RIVCELCOM4 = arr(min(CELLIERNP + CELLIERNR + CELLIERNS + CELLIERNT, LIMCELLIER) * positif(CELLIERNP + CELLIERNT) * TX36 / 100 + min(CELLIERNP + CELLIERNR + CELLIERNS + CELLIERNT, LIMCELLIER) * positif(CELLIERNR + CELLIERNS) * TX40 / 100) - 4 * RIVCELCOM1 * 1 - V_CNR
...
RIVCELJOQR4 = arr(min(CELLIERJO + CELLIERJQ + CELLIERJR, LIMCELLIER) * positif(CELLIERJQ) * TX36 / 100 + min(CELLIERJO + CELLIERJQ + CELLIERJR, LIMCELLIER) * positif(CELLIERJO + CELLIERJR) * TX24 / 100) - 4 * RIVCELJOQR1 * 1 - V_CNR
...
RIVCELNQ4 = arr(min(CELLIERNQ, LIMCELLIER) * positif(CELLIERNQ) * TX40 / 100) - 4 * RIVCELNQ1 * 1 - V_CNR
...
RIVCELJP4 = arr(min(CELLIERJP, LIMCELLIER) * positif(CELLIERJP) * TX36 / 100) - 4 * RIVCELJP1 * 1 - V_CNR
...
RIVCELHJK8 = arr(min(CELLIERHK + CELLIERHJ + 0, LIMCELLIER) * positif(CELLIERHJ) * TX25 / 100 + min(CELLIERHK + CELLIERHJ + 0, LIMCELLIER) * positif(CELLIERHK) * TX40 / 100) - 8 * RIVCELHJK1 * 1 - V_CNR
...
RIVCELHNO8 = arr(min(CELLIERHN + CELLIERHO + 0, LIMCELLIER) * positif(CELLIERHN) * TX25 / 100 + min(CELLIERHN + CELLIERHO + 0, LIMCELLIER) * positif(CELLIERHO) * TX40 / 100) - 8 * RIVCELHNO1 * 1 - V_CNR
...
RIVCELHLM8 = arr(min(CELLIERHL + CELLIERHM + 0, LIMCELLIER) * positif(CELLIERHL) * TX25 / 100 + min(CELLIERHL + CELLIERHM + 0, LIMCELLIER) * positif(CELLIERHM) * TX40 / 100) - 8 * RIVCELHLM1 * 1 - V_CNR
...
RRCEL2012 = max(0, CELREPYJ + CELREPYI + CELREPYB + CELREPYA - RCELREPYJ - RCELREPYI - RCELREPYB - RCELREPYA) * positif(somme((CELREPY(i) for i in ('J', 'I', 'B', 'A')))) + max(0, RCEL_2012_R - RCEL2012) * positif(CELSOMJ) + max(0, RCEL_JOQR_R - RCELJOQR) * positif(somme((CELLIERJ(i) for i in ('O', 'Q', 'R')))) + max(0, CELREPGV - RCELREPGV) * positif(CELREPGV) + max(0, CELREPGJ - RCELREPGJ) * positif(CELREPGJ) + max(0, RCEL_FABC_R - RCELFABC) * positif(CELLIERFA + CELLIERFB + CELLIERFC) + max(0, RCEL_FD_R - RCELFD) * positif(CELLIERFD) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RRCEL2011 = max(0, RCEL_2011_R - RCEL * positif(CELSOMN) + RCEL_COM_R - RCELCOM * positif(somme((CELLIERN(i) for i in ('P', 'R', 'S', 'T')))) + CELREPYC + CELREPYD + CELREPYK - RCELREPYC - RCELREPYD - RCELREPYK * positif(somme((CELREPY(i) for i in ('C', 'D', 'K')))) + CELREPGW + CELREPGL + CELREPGK + CELREPHG + CELREPHA + RCEL_JBGL_R + RCEL_JP_R - RCELREPGW - RCELREPGL - RCELREPGK - RCELREPHG - RCELREPHA - RCELJBGL - RCELJP * positif(somme((CELREPG(i) for i in ('W', 'L', 'K'))) + CELREPHG + CELREPHA + somme((CELLIERJ(i) for i in ('B', 'G', 'L', 'P'))))) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RRCEL2010 = max(0, CELREPYE + CELREPYF + CELREPYL - RCELREPYE - RCELREPYF - RCELREPYL * positif(CELREPYE + CELREPYF + CELREPYL) + CELREPGX + CELREPGS + CELREPGP - RCELREPGX - RCELREPGS - RCELREPGP * positif(CELREPGX + CELREPGS + CELREPGP) + CELREPHH + CELREPHD + CELREPHB + RCELREP_HW_R + RCELREP_HV_R - RCELREPHH - RCELREPHD - RCELREPHB - RCELREPHW - RCELREPHV * positif(CELREPHH + CELREPHD + CELREPHB + CELREPHW + CELREPHV) + RCEL_NQ_R + RCEL_NBGL_R + RCEL_HJK_R - RCELNQ - RCELNBGL - RCELHJK * positif(somme((CELLIERN(i) for i in ('Q', 'B', 'G', 'L'))) + CELLIERHJ + CELLIERHK)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
RRCELHH = max(0, RCEL_HL_R + RCEL_HM_R + RCEL_HNO_R + somme((RCELREP_H(i)_R for i in ('R', 'S', 'T', 'U', 'X', 'Z'))) - RCELHL + RCELHM + RCELHNO + somme((RCELREPH(i) for i in ('R', 'S', 'T', 'U', 'X', 'Z')))) * positif(somme((CELREPH(i) for i in ('R', 'S', 'T', 'U', 'X', 'Z'))) + somme((CELLIERH(i) for i in ('L', 'M', 'N', 'O'))))


RRCEL2009 = max(0, RRCELHH + CELREPGU + CELREPGT + CELREPHF + CELREPHE - RCELREPGU - RCELREPGT - RCELREPHF - RCELREPHE * positif(CELREPGU + CELREPGT + CELREPHF + CELREPHE) + CELREPYG + CELREPYH - RCELREPYG - RCELREPYH * positif(CELREPYG + CELREPYH)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
REPCEL = somme((RIVCEL(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIVCEL8


REPCEL2012 = somme((RIV2012CEL(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIV2012CEL8


REPCELNBGL = somme((RIVCELNBGL(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIVCELNBGL8


REPCELJBGL = somme((RIVCELJBGL(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIVCELJBGL8


REPCELCOM = somme((RIVCELCOM(i) for i in (1, 2, 3))) + RIVCELCOM4


REPCELJOQR = somme((RIVCELJOQR(i) for i in (1, 2, 3))) + RIVCELJOQR4


REPCELNQ = somme((RIVCELNQ(i) for i in (1, 2, 3))) + RIVCELNQ4


REPCELJP = somme((RIVCELJP(i) for i in (1, 2, 3))) + RIVCELJP4


REPCELHJK = somme((RIVCELHJK(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIVCELHJK8


REPCELHNO = somme((RIVCELHNO(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIVCELHNO8


REPCELHLM = somme((RIVCELHLM(i) for i in (1, 2, 3, 4, 5, 6, 7))) + RIVCELHLM8
...
ATOUHOTR = DTOUHOTR * 1 - ART1731BIS + min(DTOUHOTR, max(ATOUHOTR_P + ATOUHOTRP2, ATOUHOTR1731 + 0) * 1 - PREM8_11) * ART1731BIS * 1 - positif(null(2 - V_REGCO) + null(4 - V_REGCO))
...
RTOUHOTR_1 = max(min(RIHOTR, RRI1 - RLOGDOM - RCREAT - RCOMP - RRETU - RDONS - RDUFLOTOT - RPINELTOT - RNOUV - RPLAFREPME4 - RFOR - RTOURREP), 0) * 1 - positif(null(2 - V_REGCO) + null(4 - V_REGCO))
...
BADCRE = min(CREAIDE, min(LIM_AIDOMI * 1 - positif(PREMAIDE) + LIM_PREMAIDE * positif(PREMAIDE) + MAJSALDOM * positif_ou_nul(V_ANREV - V_0DA - 65) + positif_ou_nul(V_ANREV - V_0DB - 65) * BOOL_0AM + V_0CF + V_0DJ + V_0DN + V_0CH + V_0DP / 2, LIM_AIDOMI3 * 1 - positif(PREMAIDE) + LIM_PREMAIDE2 * positif(PREMAIDE)) * 1 - positif(INAIDE + 0) + LIM_AIDOMI2 * positif(INAIDE + 0))


BADPLAF = min(LIM_AIDOMI * 1 - positif(PREMAIDE) + LIM_PREMAIDE * positif(PREMAIDE) + MAJSALDOM * positif_ou_nul(V_ANREV - V_0DA - 65) + positif_ou_nul(V_ANREV - V_0DB - 65) * BOOL_0AM + V_0CF + V_0DJ + V_0DN + V_0CH + V_0DP / 2, LIM_AIDOMI3 * 1 - positif(PREMAIDE) + LIM_PREMAIDE2 * positif(PREMAIDE)) * 1 - positif(INAIDE + 0) + LIM_AIDOMI2 * positif(INAIDE + 0) * positif(RVAIDE)


BADPLAF2 = min(LIM_AIDOMI * 1 - positif(PREMAIDE) + LIM_PREMAIDE * positif(PREMAIDE) + MAJSALDOM * positif_ou_nul(V_ANREV - V_0DA - 65) + positif_ou_nul(V_ANREV - V_0DB - 65) * BOOL_0AM + ASCAPA + V_0CF + V_0DJ + V_0DN + V_0CH + V_0DP / 2, LIM_AIDOMI3 * 1 - positif(PREMAIDE) + LIM_PREMAIDE2 * positif(PREMAIDE)) * 1 - positif(INAIDE + 0) + LIM_AIDOMI2 * positif(INAIDE + 0) * positif(RVAIDAS)
...
RPRESCOMPREP = max(min(RPRESCOMP, IDOM11 - DEC11 - RCOTFOR - RREPA - RFIPDOM - RAIDE - RDIFAGRI - RFORET - RFIPC - RCINE - RRESTIMO - RSOCREPR), 0) * positif(RDPRESREPORT)
...
NRTOUHOTR = max(min(RIHOTR, RRI1 - NRLOGDOM - NRCREAT - NRCOMP - NRRETU - NRDONS - NRDUFREPFI - NRDUFLOGIH - NRDUFLOEKL - NRPIQABCD - NRNOUV - NRPLAFPME - NRFOR - NRTOURREP), 0) * 1 - positif(null(2 - V_REGCO) + null(4 - V_REGCO))
...
NRCELRREDLN = max(min(CELRREDLN, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M')))), 0)


NRCELRREDLC = max(min(CELRREDLC, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N')))), 0)


NRCELRREDLD = max(min(CELRREDLD, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C')))), 0)


NRCELRREDLS = max(min(CELRREDLS, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D')))), 0)


NRCELRREDLT = max(min(CELRREDLT, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S')))), 0)


NRCELRREDLF = max(min(CELRREDLF, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T')))), 0)


NRCELRREDLZ = max(min(CELRREDLZ, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F')))), 0)


NRCELRREDLX = max(min(CELRREDLX, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z')))), 0)


NRCELRREDMG = max(min(CELRREDMG, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X')))), 0)


NRCELRREDMH = max(min(CELRREDMH, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG), 0)


NRCELREPHS = max(min(RCELREP_HS, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH), 0)


NRCELREPHR = max(min(RCELREP_HR, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S',)))), 0)


NRCELREPHU = max(min(RCELREP_HU, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R')))), 0)


NRCELREPHT = max(min(RCELREP_HT, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U')))), 0)


NRCELREPHZ = max(min(RCELREP_HZ, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T')))), 0)


NRCELREPHX = max(min(RCELREP_HX, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z')))), 0)


NRCELREPHW = max(min(RCELREP_HW, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X')))), 0)


NRCELREPHV = max(min(RCELREP_HV, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W')))), 0)


NRCELREPHF = max(min(ACELREPHF, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V')))), 0)


NRCELREPHE = max(min(ACELREPHE, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F')))), 0)


NRCELREPHD = max(min(ACELREPHD, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E')))), 0)


NRCELREPHH = max(min(ACELREPHH, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D')))), 0)


NRCELREPHG = max(min(ACELREPHG, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H')))), 0)


NRCELREPHB = max(min(ACELREPHB, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G')))), 0)


NRCELREPHA = max(min(ACELREPHA, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B')))), 0)


NRCELREPGU = max(min(ACELREPGU, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B')))), 0)


NRCELREPGX = max(min(ACELREPGX, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U',)))), 0)


NRCELREPGT = max(min(ACELREPGT, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X')))), 0)


NRCELREPGS = max(min(ACELREPGS, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T')))), 0)


NRCELREPGW = max(min(ACELREPGW, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S')))), 0)


NRCELREPGP = max(min(ACELREPGP, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W')))), 0)


NRCELREPGL = max(min(ACELREPGL, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P')))), 0)


NRCELREPGV = max(min(ACELREPGV, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L')))), 0)


NRCELREPGK = max(min(ACELREPGK, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V')))), 0)


NRCELREPGJ = max(min(ACELREPGJ, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K')))), 0)


NRCELREPYH = max(min(ACELREPYH, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J')))), 0)


NRCELREPYL = max(min(ACELREPYL, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H',)))), 0)


NRCELREPYG = max(min(ACELREPYG, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L')))), 0)


NRCELREPYF = max(min(ACELREPYF, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G')))), 0)


NRCELREPYK = max(min(ACELREPYK, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F')))), 0)


NRCELREPYE = max(min(ACELREPYE, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K')))), 0)


NRCELREPYD = max(min(ACELREPYD, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E')))), 0)


NRCELREPYJ = max(min(ACELREPYJ, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D')))), 0)


NRCELREPYC = max(min(ACELREPYC, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J')))), 0)


NRCELREPYB = max(min(ACELREPYB, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C')))), 0)


NRCELREPYI = max(min(ACELREPYI, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B')))), 0)


NRCELREPYA = max(min(ACELREPYA, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I')))), 0)


NRCELHM = max(min(RCEL_HM, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A')))), 0)


NRCELHL = max(min(RCEL_HL, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM), 0)


NRCELHNO = max(min(RCEL_HNO, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL), 0)


NRCELHJK = max(min(RCEL_HJK, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO), 0)


NRCELNQ = max(min(RCEL_NQ, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK), 0)


NRCELNBGL = max(min(RCEL_NBGL, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ), 0)


NRCELCOM = max(min(RCEL_COM, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL), 0)


NRCEL = max(min(RCEL_2011, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM), 0)


NRCELJP = max(min(RCEL_JP, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM - NRCEL), 0)


NRCELJBGL = max(min(RCEL_JBGL, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM - NRCEL - NRCELJP), 0)


NRCELJOQR = max(min(RCEL_JOQR, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM - NRCEL - NRCELJP - NRCELJBGL), 0)


NRCEL2012 = max(min(RCEL_2012, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM - NRCEL - NRCELJP - NRCELJBGL - NRCELJOQR), 0)


NRCELFD = max(min(RCEL_FD, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM - NRCEL - NRCELJP - NRCELJBGL - NRCELJOQR - NRCEL2012), 0)


NRCELFABC = max(min(RCEL_FABC, RRI1 - NRLOGDOM - NRRI2 - somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) - NRCELRREDMG - NRCELRREDMH - somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) - somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) - somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) - NRCELHM - NRCELHL - NRCELHNO - NRCELHJK - NRCELNQ - NRCELNBGL - NRCELCOM - NRCEL - NRCELJP - NRCELJBGL - NRCELJOQR - NRCEL2012 - NRCELFD), 0)


NRCELTOT = somme((NRCELRREDL(i) for i in ('A', 'B', 'E', 'M', 'N', 'C', 'D', 'S', 'T', 'F', 'Z', 'X'))) + NRCELRREDMG + NRCELRREDMH + somme((NRCELREPH(i) for i in ('S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V', 'F', 'E', 'D', 'H', 'G', 'B', 'A'))) + somme((NRCELREPG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) + somme((NRCELREPY(i) for i in ('H', 'L', 'G', 'F', 'K', 'E', 'D', 'J', 'C', 'B', 'I', 'A'))) + NRCELHM + NRCELHL + NRCELHNO + NRCELHJK + NRCELNQ + NRCELNBGL + NRCELCOM + NRCEL + NRCELJP + NRCELJBGL + NRCELJOQR + NRCEL2012 + NRCELFD + NRCELFABC
...
RSOC14 = arr(max(min(INVRETKI * 1 - INDPLAF + INVRETKIA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 13)))), 0)) * 1 - V_CNR


RSOC15 = arr(max(min(INVRETKHR * 1 - INDPLAF + INVRETKHRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 14)))), 0)) * 1 - V_CNR


RSOC16 = arr(max(min(INVRETKIR * 1 - INDPLAF + INVRETKIRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 15)))), 0)) * 1 - V_CNR


RSOC17 = arr(max(min(INVRETQN * 1 - INDPLAF + INVRETQNA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 16)))), 0)) * 1 - V_CNR


RSOC18 = arr(max(min(INVRETQU * 1 - INDPLAF + INVRETQUA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 17)))), 0)) * 1 - V_CNR


RSOC19 = arr(max(min(INVRETQK * 1 - INDPLAF + INVRETQKA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 18)))), 0)) * 1 - V_CNR


RSOC20 = arr(max(min(INVRETQNR * 1 - INDPLAF + INVRETQNRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 19)))), 0)) * 1 - V_CNR


RSOC21 = arr(max(min(INVRETQUR * 1 - INDPLAF + INVRETQURA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 20)))), 0)) * 1 - V_CNR


RSOC22 = arr(max(min(INVRETQKR * 1 - INDPLAF + INVRETQKRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 21)))), 0)) * 1 - V_CNR


RSOC23 = arr(max(min(INVRETQJ * 1 - INDPLAF + INVRETQJA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 22)))), 0)) * 1 - V_CNR


RSOC24 = arr(max(min(INVRETQS * 1 - INDPLAF + INVRETQSA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 23)))), 0)) * 1 - V_CNR


RSOC25 = arr(max(min(INVRETQW * 1 - INDPLAF + INVRETQWA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 24)))), 0)) * 1 - V_CNR


RSOC26 = arr(max(min(INVRETQX * 1 - INDPLAF + INVRETQXA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 25)))), 0)) * 1 - V_CNR


RSOC27 = arr(max(min(INVRETQJR * 1 - INDPLAF + INVRETQJRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 26)))), 0)) * 1 - V_CNR


RSOC28 = arr(max(min(INVRETQSR * 1 - INDPLAF + INVRETQSRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 27)))), 0)) * 1 - V_CNR


RSOC29 = arr(max(min(INVRETQWR * 1 - INDPLAF + INVRETQWRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 28)))), 0)) * 1 - V_CNR


RSOC30 = arr(max(min(INVRETQXR * 1 - INDPLAF + INVRETQXRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 29)))), 0)) * 1 - V_CNR


RSOC31 = arr(max(min(INVRETRA * 1 - INDPLAF + INVRETRAA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 30)))), 0)) * 1 - V_CNR


RSOC32 = arr(max(min(INVRETRB * 1 - INDPLAF + INVRETRBA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 31)))), 0)) * 1 - V_CNR


RSOC33 = arr(max(min(INVRETRC * 1 - INDPLAF + INVRETRCA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 32)))), 0)) * 1 - V_CNR


RSOC34 = arr(max(min(INVRETRD * 1 - INDPLAF + INVRETRDA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 33)))), 0)) * 1 - V_CNR


RSOC35 = arr(max(min(INVRETRAR * 1 - INDPLAF + INVRETRARA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 34)))), 0)) * 1 - V_CNR


RSOC36 = arr(max(min(INVRETRBR * 1 - INDPLAF + INVRETRBRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 35)))), 0)) * 1 - V_CNR


RSOC37 = arr(max(min(INVRETRCR * 1 - INDPLAF + INVRETRCRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 36)))), 0)) * 1 - V_CNR


RSOC38 = arr(max(min(INVRETRDR * 1 - INDPLAF + INVRETRDRA * INDPLAF, RRISUP - somme((RSOC(i) for i in interval(11, 37)))), 0)) * 1 - V_CNR


RDOMSOC1_1 = 1 - V_CNR * 1 - V_INDTEO * somme((RSOC(i) for i in interval(11, 38))) + V_INDTEO * arr(V_RSOC11 + V_RSOC12 + V_RSOC13 + V_RSOC15 + V_RSOC17 + V_RSOC20 + V_RSOC23 + V_RSOC27 + V_RSOC14 + V_RSOC16 + V_RSOC18 + V_RSOC21 + V_RSOC24 + V_RSOC28 + V_RSOC31 + V_RSOC35 + V_RSOC19 + V_RSOC22 + V_RSOC25 + V_RSOC29 + V_RSOC32 + V_RSOC36 + V_RSOC26 + V_RSOC30 + V_RSOC33 + V_RSOC37 + V_RSOC34 + V_RSOC38 * TX65 / 100)
...
RENT06 = max(min(INVRETBB * 1 - INDPLAF + INVRETBBA * INDPLAF, RRIRENT - somme((RENT0(i) for i in interval(1, 5)))), 0) * 1 - V_CNR


RENT07 = max(min(INVRETAA * 1 - INDPLAF + INVRETAAA * INDPLAF, RRIRENT - somme((RENT0(i) for i in interval(1, 6)))), 0) * 1 - V_CNR


RENT08 = max(min(INVRETAF * 1 - INDPLAF + INVRETAFA * INDPLAF, RRIRENT - somme((RENT0(i) for i in interval(1, 7)))), 0) * 1 - V_CNR


RENT09 = max(min(INVRETAK * 1 - INDPLAF + INVRETAKA * INDPLAF, RRIRENT - somme((RENT0(i) for i in interval(1, 8)))), 0) * 1 - V_CNR


RENT10 = max(min(INVRETAP * 1 - INDPLAF + INVRETAPA * INDPLAF, RRIRENT - somme((RENT0(i) for i in interval(1, 9)))), 0) * 1 - V_CNR


RENT11 = max(min(INVRETAU * 1 - INDPLAF + INVRETAUA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 10)))), 0) * 1 - V_CNR


RENT12 = max(min(INVRETBA * 1 - INDPLAF + INVRETBAA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 11)))), 0) * 1 - V_CNR


RENT13 = max(min(INVRETAC * 1 - INDPLAF + INVRETACA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 12)))), 0) * 1 - V_CNR


RENT14 = max(min(INVRETAH * 1 - INDPLAF + INVRETAHA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 13)))), 0) * 1 - V_CNR


RENT15 = max(min(INVRETAM * 1 - INDPLAF + INVRETAMA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 14)))), 0) * 1 - V_CNR


RENT16 = max(min(INVRETAR * 1 - INDPLAF + INVRETARA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 15)))), 0) * 1 - V_CNR


RENT17 = max(min(INVRETAW * 1 - INDPLAF + INVRETAWA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 16)))), 0) * 1 - V_CNR


RENT18 = max(min(INVRETBE * 1 - INDPLAF + INVRETBEA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 17)))), 0) * 1 - V_CNR


RENT19 = max(min(INVRETAE * 1 - INDPLAF + INVRETAEA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 18)))), 0) * 1 - V_CNR


RENT20 = max(min(INVRETAJ * 1 - INDPLAF + INVRETAJA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 19)))), 0) * 1 - V_CNR


RENT21 = max(min(INVRETAO * 1 - INDPLAF + INVRETAOA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 20)))), 0) * 1 - V_CNR


RENT22 = max(min(INVRETAT * 1 - INDPLAF + INVRETATA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 21)))), 0) * 1 - V_CNR


RENT23 = max(min(INVRETAY * 1 - INDPLAF + INVRETAYA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 22)))), 0) * 1 - V_CNR


RENT24 = max(min(INVRETBG * 1 - INDPLAF + INVRETBGA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 23)))), 0) * 1 - V_CNR


RENT25 = max(min(INVRETABR * 1 - INDPLAF + INVRETABRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 24)))), 0) * 1 - V_CNR


RENT26 = max(min(INVRETAGR * 1 - INDPLAF + INVRETAGRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 25)))), 0) * 1 - V_CNR


RENT27 = max(min(INVRETALR * 1 - INDPLAF + INVRETALRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 26)))), 0) * 1 - V_CNR


RENT28 = max(min(INVRETAQR * 1 - INDPLAF + INVRETAQRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 27)))), 0) * 1 - V_CNR


RENT29 = max(min(INVRETAVR * 1 - INDPLAF + INVRETAVRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 28)))), 0) * 1 - V_CNR


RENT30 = max(min(INVRETBBR * 1 - INDPLAF + INVRETBBRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 29)))), 0) * 1 - V_CNR


RENT31 = max(min(INVRETAAR * 1 - INDPLAF + INVRETAARA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 30)))), 0) * 1 - V_CNR


RENT32 = max(min(INVRETAFR * 1 - INDPLAF + INVRETAFRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 31)))), 0) * 1 - V_CNR


RENT33 = max(min(INVRETAKR * 1 - INDPLAF + INVRETAKRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 32)))), 0) * 1 - V_CNR


RENT34 = max(min(INVRETAPR * 1 - INDPLAF + INVRETAPRA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 33)))), 0) * 1 - V_CNR


RENT35 = max(min(INVRETAUR * 1 - INDPLAF + INVRETAURA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 34)))), 0) * 1 - V_CNR


RENT36 = max(min(INVRETBAR * 1 - INDPLAF + INVRETBARA * INDPLAF, RRIRENT - somme((RENT(i) for i in interval(1, 35)))), 0) * 1 - V_CNR


RLOCENT_1 = 1 - V_INDTEO * somme((RENT(i) for i in interval(1, 36))) + V_INDTEO * arr(V_RENT07 + V_RENT31 * 5263 / 10000) + arr(V_RENT01 + V_RENT25 * 625 / 1000) + arr(V_RENT09 + V_RENT33 * 5263 / 10000) + arr(V_RENT03 + V_RENT27 * 625 / 1000) + arr(V_RENT08 + V_RENT32 * 5263 / 10000) + arr(V_RENT02 + V_RENT26 * 625 / 1000) + arr(V_RENT10 + V_RENT34 * 5263 / 10000) + arr(V_RENT04 + V_RENT28 * 625 / 1000) + arr(V_RENT11 + V_RENT35 * 5263 / 10000) + arr(V_RENT05 + V_RENT29 * 625 / 1000) + arr(V_RENT12 + V_RENT36 * 5263 / 10000) + arr(V_RENT06 + V_RENT30 * 625 / 1000) * 1 - V_CNR
...
RLOG11 = max(min(INVRETQD * 1 - INDPLAF + INVRETQDA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 10)))), 0) * 1 - V_CNR


RLOG12 = max(min(INVRETOB * 1 - INDPLAF + INVRETOBA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 11)))), 0) * 1 - V_CNR


RLOG13 = max(min(INVRETOC * 1 - INDPLAF + INVRETOCA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 12)))), 0) * 1 - V_CNR


RLOG14 = max(min(INVRETOI * 1 - INDPLAF + INVRETOIA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 13)))), 0) * 1 - V_CNR


RLOG15 = max(min(INVRETOJ * 1 - INDPLAF + INVRETOJA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 14)))), 0) * 1 - V_CNR


RLOG16 = max(min(INVRETOK * 1 - INDPLAF + INVRETOKA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 15)))), 0) * 1 - V_CNR


RLOG17 = max(min(INVRETOM * 1 - INDPLAF + INVRETOMA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 16)))), 0) * 1 - V_CNR


RLOG18 = max(min(INVRETON * 1 - INDPLAF + INVRETONA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 17)))), 0) * 1 - V_CNR


RLOG19 = max(min(INVRETOP * 1 - INDPLAF + INVRETOPA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 18)))), 0) * 1 - V_CNR


RLOG20 = max(min(INVRETOQ * 1 - INDPLAF + INVRETOQA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 19)))), 0) * 1 - V_CNR


RLOG21 = max(min(INVRETOR * 1 - INDPLAF + INVRETORA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 20)))), 0) * 1 - V_CNR


RLOG22 = max(min(INVRETOT * 1 - INDPLAF + INVRETOTA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 21)))), 0) * 1 - V_CNR


RLOG23 = max(min(INVRETOU * 1 - INDPLAF + INVRETOUA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 22)))), 0) * 1 - V_CNR


RLOG24 = max(min(INVRETOV * 1 - INDPLAF + INVRETOVA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 23)))), 0) * 1 - V_CNR


RLOG25 = max(min(INVRETOW * 1 - INDPLAF + INVRETOWA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 24)))), 0) * 1 - V_CNR


RLOG26 = max(min(INVRETOD * 1 - INDPLAF + INVRETODA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 25)))), 0) * 1 - V_CNR


RLOG27 = max(min(INVRETOE * 1 - INDPLAF + INVRETOEA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 26)))), 0) * 1 - V_CNR


RLOG28 = max(min(INVRETOF * 1 - INDPLAF + INVRETOFA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 27)))), 0) * 1 - V_CNR


RLOG29 = max(min(INVRETOG * 1 - INDPLAF + INVRETOGA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 28)))), 0) * 1 - V_CNR


RLOG30 = max(min(INVRETOX * 1 - INDPLAF + INVRETOXA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 29)))), 0) * 1 - V_CNR


RLOG31 = max(min(INVRETOY * 1 - INDPLAF + INVRETOYA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 30)))), 0) * 1 - V_CNR


RLOG32 = max(min(INVRETOZ * 1 - INDPLAF + INVRETOZA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 31)))), 0) * 1 - V_CNR


RLOG33 = max(min(INVRETUA * 1 - INDPLAF + INVRETUAA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 32)))), 0) * 1 - V_CNR


RLOG34 = max(min(INVRETUB * 1 - INDPLAF + INVRETUBA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 33)))), 0) * 1 - V_CNR


RLOG35 = max(min(INVRETUC * 1 - INDPLAF + INVRETUCA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 34)))), 0) * 1 - V_CNR


RLOG36 = max(min(INVRETUD * 1 - INDPLAF + INVRETUDA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 35)))), 0) * 1 - V_CNR


RLOG37 = max(min(INVRETUE * 1 - INDPLAF + INVRETUEA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 36)))), 0) * 1 - V_CNR


RLOG38 = max(min(INVRETUF * 1 - INDPLAF + INVRETUFA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 37)))), 0) * 1 - V_CNR


RLOG39 = max(min(INVRETUG * 1 - INDPLAF + INVRETUGA * INDPLAF, RRI1 - somme((RLOG(i) for i in interval(1, 38)))), 0) * 1 - V_CNR


RLOGDOM_1 = 1 - V_INDTEO * somme((RLOG(i) for i in interval(1, 39))) + V_INDTEO * RLOG01 + RLOG02 + RLOG03 + RLOG04 + RLOG05 + RLOG06 + RLOG07 + RLOG08
...
RLOC11 = max(min(INVRETLI * 1 - INDPLAF + INVRETLIA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 10)))), 0) * 1 - V_CNR


RLOC12 = max(min(INVRETKT * 1 - INDPLAF + INVRETKTA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 11)))), 0) * 1 - V_CNR


RLOC13 = max(min(INVRETKU * 1 - INDPLAF + INVRETKUA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 12)))), 0) * 1 - V_CNR


RLOC14 = max(min(INVRETMBR * 1 - INDPLAF + INVRETMBRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 13)))), 0) * 1 - V_CNR


RLOC15 = max(min(INVRETMCR * 1 - INDPLAF + INVRETMCRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 14)))), 0) * 1 - V_CNR


RLOC16 = max(min(INVRETLHR * 1 - INDPLAF + INVRETLHRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 15)))), 0) * 1 - V_CNR


RLOC17 = max(min(INVRETLIR * 1 - INDPLAF + INVRETLIRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 16)))), 0) * 1 - V_CNR


RLOC18 = max(min(INVOMQV, RRILOC - somme((RLOC(i) for i in interval(1, 17)))), 0) * 1 - V_CNR


RLOC19 = max(min(INVENDEB2009, RRILOC - somme((RLOC(i) for i in interval(1, 18)))), 0) * 1 - V_CNR


RLOC20 = max(min(INVRETQP * 1 - INDPLAF + INVRETQPA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 19)))), 0) * 1 - V_CNR


RLOC21 = max(min(INVRETQG * 1 - INDPLAF + INVRETQGA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 20)))), 0) * 1 - V_CNR


RLOC22 = max(min(INVRETPB * 1 - INDPLAF + INVRETPBA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 21)))), 0) * 1 - V_CNR


RLOC23 = max(min(INVRETPF * 1 - INDPLAF + INVRETPFA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 22)))), 0) * 1 - V_CNR


RLOC24 = max(min(INVRETPJ * 1 - INDPLAF + INVRETPJA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 23)))), 0) * 1 - V_CNR


RLOC25 = max(min(INVRETQO * 1 - INDPLAF + INVRETQOA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 24)))), 0) * 1 - V_CNR


RLOC26 = max(min(INVRETQF * 1 - INDPLAF + INVRETQFA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 25)))), 0) * 1 - V_CNR


RLOC27 = max(min(INVRETPA * 1 - INDPLAF + INVRETPAA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 26)))), 0) * 1 - V_CNR


RLOC28 = max(min(INVRETPE * 1 - INDPLAF + INVRETPEA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 27)))), 0) * 1 - V_CNR


RLOC29 = max(min(INVRETPI * 1 - INDPLAF + INVRETPIA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 28)))), 0) * 1 - V_CNR


RLOC30 = max(min(INVRETQR * 1 - INDPLAF + INVRETQRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 29)))), 0) * 1 - V_CNR


RLOC31 = max(min(INVRETQI * 1 - INDPLAF + INVRETQIA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 30)))), 0) * 1 - V_CNR


RLOC32 = max(min(INVRETPD * 1 - INDPLAF + INVRETPDA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 31)))), 0) * 1 - V_CNR


RLOC33 = max(min(INVRETPH * 1 - INDPLAF + INVRETPHA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 32)))), 0) * 1 - V_CNR


RLOC34 = max(min(INVRETPL * 1 - INDPLAF + INVRETPLA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 33)))), 0) * 1 - V_CNR


RLOC35 = max(min(INVRETQPR * 1 - INDPLAF + INVRETQPRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 34)))), 0) * 1 - V_CNR


RLOC36 = max(min(INVRETQGR * 1 - INDPLAF + INVRETQGRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 35)))), 0) * 1 - V_CNR


RLOC37 = max(min(INVRETPBR * 1 - INDPLAF + INVRETPBRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 36)))), 0) * 1 - V_CNR


RLOC38 = max(min(INVRETPFR * 1 - INDPLAF + INVRETPFRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 37)))), 0) * 1 - V_CNR


RLOC39 = max(min(INVRETPJR * 1 - INDPLAF + INVRETPJRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 38)))), 0) * 1 - V_CNR


RLOC40 = max(min(INVRETQOR * 1 - INDPLAF + INVRETQORA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 39)))), 0) * 1 - V_CNR


RLOC41 = max(min(INVRETQFR * 1 - INDPLAF + INVRETQFRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 40)))), 0) * 1 - V_CNR


RLOC42 = max(min(INVRETPAR * 1 - INDPLAF + INVRETPARA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 41)))), 0) * 1 - V_CNR


RLOC43 = max(min(INVRETPER * 1 - INDPLAF + INVRETPERA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 42)))), 0) * 1 - V_CNR


RLOC44 = max(min(INVRETPIR * 1 - INDPLAF + INVRETPIRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 43)))), 0) * 1 - V_CNR


RLOC45 = max(min(INVOMRETPM, RRILOC - somme((RLOC(i) for i in interval(1, 44)))), 0) * 1 - V_CNR


RLOC46 = max(min(INVOMENTRJ, RRILOC - somme((RLOC(i) for i in interval(1, 45)))), 0) * 1 - V_CNR


RLOC47 = max(min(INVRETPO * 1 - INDPLAF + INVRETPOA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 46)))), 0) * 1 - V_CNR


RLOC48 = max(min(INVRETPT * 1 - INDPLAF + INVRETPTA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 47)))), 0) * 1 - V_CNR


RLOC49 = max(min(INVRETPY * 1 - INDPLAF + INVRETPYA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 48)))), 0) * 1 - V_CNR


RLOC50 = max(min(INVRETRL * 1 - INDPLAF + INVRETRLA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 49)))), 0) * 1 - V_CNR


RLOC51 = max(min(INVRETRQ * 1 - INDPLAF + INVRETRQA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 50)))), 0) * 1 - V_CNR


RLOC52 = max(min(INVRETRV * 1 - INDPLAF + INVRETRVA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 51)))), 0) * 1 - V_CNR


RLOC53 = max(min(INVRETNV * 1 - INDPLAF + INVRETNVA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 52)))), 0) * 1 - V_CNR


RLOC54 = max(min(INVRETPN * 1 - INDPLAF + INVRETPNA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 53)))), 0) * 1 - V_CNR


RLOC55 = max(min(INVRETPS * 1 - INDPLAF + INVRETPSA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 54)))), 0) * 1 - V_CNR


RLOC56 = max(min(INVRETPX * 1 - INDPLAF + INVRETPXA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 55)))), 0) * 1 - V_CNR


RLOC57 = max(min(INVRETRK * 1 - INDPLAF + INVRETRKA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 56)))), 0) * 1 - V_CNR


RLOC58 = max(min(INVRETRP * 1 - INDPLAF + INVRETRPA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 57)))), 0) * 1 - V_CNR


RLOC59 = max(min(INVRETRU * 1 - INDPLAF + INVRETRUA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 58)))), 0) * 1 - V_CNR


RLOC60 = max(min(INVRETNU * 1 - INDPLAF + INVRETNUA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 59)))), 0) * 1 - V_CNR


RLOC61 = max(min(INVRETPP * 1 - INDPLAF + INVRETPPA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 60)))), 0) * 1 - V_CNR


RLOC62 = max(min(INVRETPU * 1 - INDPLAF + INVRETPUA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 61)))), 0) * 1 - V_CNR


RLOC63 = max(min(INVRETRG * 1 - INDPLAF + INVRETRGA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 62)))), 0) * 1 - V_CNR


RLOC64 = max(min(INVRETRM * 1 - INDPLAF + INVRETRMA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 63)))), 0) * 1 - V_CNR


RLOC65 = max(min(INVRETRR * 1 - INDPLAF + INVRETRRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 64)))), 0) * 1 - V_CNR


RLOC66 = max(min(INVRETRW * 1 - INDPLAF + INVRETRWA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 65)))), 0) * 1 - V_CNR


RLOC67 = max(min(INVRETNW * 1 - INDPLAF + INVRETNWA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 66)))), 0) * 1 - V_CNR


RLOC68 = max(min(INVRETPR * 1 - INDPLAF + INVRETPRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 67)))), 0) * 1 - V_CNR


RLOC69 = max(min(INVRETPW * 1 - INDPLAF + INVRETPWA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 68)))), 0) * 1 - V_CNR


RLOC70 = max(min(INVRETRI * 1 - INDPLAF + INVRETRIA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 69)))), 0) * 1 - V_CNR


RLOC71 = max(min(INVRETRO * 1 - INDPLAF + INVRETROA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 70)))), 0) * 1 - V_CNR


RLOC72 = max(min(INVRETRT * 1 - INDPLAF + INVRETRTA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 71)))), 0) * 1 - V_CNR


RLOC73 = max(min(INVRETRY * 1 - INDPLAF + INVRETRYA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 72)))), 0) * 1 - V_CNR


RLOC74 = max(min(INVRETNY * 1 - INDPLAF + INVRETNYA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 73)))), 0) * 1 - V_CNR


RLOC75 = max(min(INVRETPOR * 1 - INDPLAF + INVRETPORA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 74)))), 0) * 1 - V_CNR


RLOC76 = max(min(INVRETPTR * 1 - INDPLAF + INVRETPTRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 75)))), 0) * 1 - V_CNR


RLOC77 = max(min(INVRETPYR * 1 - INDPLAF + INVRETPYRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 76)))), 0) * 1 - V_CNR


RLOC78 = max(min(INVRETRLR * 1 - INDPLAF + INVRETRLRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 77)))), 0) * 1 - V_CNR


RLOC79 = max(min(INVRETRQR * 1 - INDPLAF + INVRETRQRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 78)))), 0) * 1 - V_CNR


RLOC80 = max(min(INVRETRVR * 1 - INDPLAF + INVRETRVRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 79)))), 0) * 1 - V_CNR


RLOC81 = max(min(INVRETNVR * 1 - INDPLAF + INVRETNVRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 80)))), 0) * 1 - V_CNR


RLOC82 = max(min(INVRETPNR * 1 - INDPLAF + INVRETPNRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 81)))), 0) * 1 - V_CNR


RLOC83 = max(min(INVRETPSR * 1 - INDPLAF + INVRETPSRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 82)))), 0) * 1 - V_CNR


RLOC84 = max(min(INVRETPXR * 1 - INDPLAF + INVRETPXRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 83)))), 0) * 1 - V_CNR


RLOC85 = max(min(INVRETRKR * 1 - INDPLAF + INVRETRKRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 84)))), 0) * 1 - V_CNR


RLOC86 = max(min(INVRETRPR * 1 - INDPLAF + INVRETRPRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 85)))), 0) * 1 - V_CNR


RLOC87 = max(min(INVRETRUR * 1 - INDPLAF + INVRETRURA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 86)))), 0) * 1 - V_CNR


RLOC88 = max(min(INVRETNUR * 1 - INDPLAF + INVRETNURA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 87)))), 0) * 1 - V_CNR


RLOC89 = max(min(INVRETSB * 1 - INDPLAF + INVRETSBA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 88)))), 0) * 1 - V_CNR


RLOC90 = max(min(INVRETSG * 1 - INDPLAF + INVRETSGA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 89)))), 0) * 1 - V_CNR


RLOC91 = max(min(INVRETSL * 1 - INDPLAF + INVRETSLA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 90)))), 0) * 1 - V_CNR


RLOC92 = max(min(INVRETSQ * 1 - INDPLAF + INVRETSQA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 91)))), 0) * 1 - V_CNR


RLOC93 = max(min(INVRETSV * 1 - INDPLAF + INVRETSVA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 92)))), 0) * 1 - V_CNR


RLOC94 = max(min(INVRETTA * 1 - INDPLAF + INVRETTAA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 93)))), 0) * 1 - V_CNR


RLOC95 = max(min(INVRETSA * 1 - INDPLAF + INVRETSAA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 94)))), 0) * 1 - V_CNR


RLOC96 = max(min(INVRETSF * 1 - INDPLAF + INVRETSFA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 95)))), 0) * 1 - V_CNR


RLOC97 = max(min(INVRETSK * 1 - INDPLAF + INVRETSKA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 96)))), 0) * 1 - V_CNR


RLOC98 = max(min(INVRETSP * 1 - INDPLAF + INVRETSPA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 97)))), 0) * 1 - V_CNR


RLOC99 = max(min(INVRETSU * 1 - INDPLAF + INVRETSUA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 98)))), 0) * 1 - V_CNR


RLOC100 = max(min(INVRETSZ * 1 - INDPLAF + INVRETSZA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99)))), 0) * 1 - V_CNR


RLOC101 = max(min(INVRETSC * 1 - INDPLAF + INVRETSCA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - RLOC100), 0) * 1 - V_CNR


RLOC102 = max(min(INVRETSH * 1 - INDPLAF + INVRETSHA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - RLOC100 - RLOC101), 0) * 1 - V_CNR


RLOC103 = max(min(INVRETSM * 1 - INDPLAF + INVRETSMA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 2)))), 0) * 1 - V_CNR


RLOC104 = max(min(INVRETSR * 1 - INDPLAF + INVRETSRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 3)))), 0) * 1 - V_CNR


RLOC105 = max(min(INVRETSW * 1 - INDPLAF + INVRETSWA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 4)))), 0) * 1 - V_CNR


RLOC106 = max(min(INVRETTB * 1 - INDPLAF + INVRETTBA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 5)))), 0) * 1 - V_CNR


RLOC107 = max(min(INVRETSE * 1 - INDPLAF + INVRETSEA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 6)))), 0) * 1 - V_CNR


RLOC108 = max(min(INVRETSJ * 1 - INDPLAF + INVRETSJA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 7)))), 0) * 1 - V_CNR


RLOC109 = max(min(INVRETSO * 1 - INDPLAF + INVRETSOA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 8)))), 0) * 1 - V_CNR


RLOC110 = max(min(INVRETST * 1 - INDPLAF + INVRETSTA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC10(i) for i in interval(0, 9)))), 0) * 1 - V_CNR


RLOC111 = max(min(INVRETSY * 1 - INDPLAF + INVRETSYA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 10)))), 0) * 1 - V_CNR


RLOC112 = max(min(INVRETTD * 1 - INDPLAF + INVRETTDA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 11)))), 0) * 1 - V_CNR


RLOC113 = max(min(INVRETSBR * 1 - INDPLAF + INVRETSBRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 12)))), 0) * 1 - V_CNR


RLOC114 = max(min(INVRETSGR * 1 - INDPLAF + INVRETSGRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 13)))), 0) * 1 - V_CNR


RLOC115 = max(min(INVRETSAR * 1 - INDPLAF + INVRETSARA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 14)))), 0) * 1 - V_CNR


RLOC116 = max(min(INVRETSFR * 1 - INDPLAF + INVRETSFRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 15)))), 0) * 1 - V_CNR


RLOC117 = max(min(INVRETSLR * 1 - INDPLAF + INVRETSLRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 16)))), 0) * 1 - V_CNR


RLOC118 = max(min(INVRETSQR * 1 - INDPLAF + INVRETSQRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 17)))), 0) * 1 - V_CNR


RLOC119 = max(min(INVRETSVR * 1 - INDPLAF + INVRETSVRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 18)))), 0) * 1 - V_CNR


RLOC120 = max(min(INVRETTAR * 1 - INDPLAF + INVRETTARA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 19)))), 0) * 1 - V_CNR


RLOC121 = max(min(INVRETSKR * 1 - INDPLAF + INVRETSKRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 20)))), 0) * 1 - V_CNR


RLOC122 = max(min(INVRETSPR * 1 - INDPLAF + INVRETSPRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 21)))), 0) * 1 - V_CNR


RLOC123 = max(min(INVRETSUR * 1 - INDPLAF + INVRETSURA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 22)))), 0) * 1 - V_CNR


RLOC124 = max(min(INVRETSZR * 1 - INDPLAF + INVRETSZRA * INDPLAF, RRILOC - somme((RLOC(i) for i in interval(1, 99))) - somme((RLOC1(i) for i in interval(0, 23)))), 0) * 1 - V_CNR


RCOLENT_1 = 1 - V_INDTEO * somme((RLOC(i) for i in interval(1, 99))) + somme((RLOC1(i) for i in interval(0, 24))) + V_INDTEO * RLOC01 + RLOC07 + RLOC18 + RLOC19 + RLOC45 + RLOC46 + arr(V_RLOC03 + V_RLOC06 * TX50 / 100) + arr(V_RLOC02 + V_RLOC05 * TX60 / 100) + arr(V_RLOC10 + V_RLOC16 * TX50 / 100) + arr(V_RLOC08 + V_RLOC14 * TX60 / 100) + arr(V_RLOC25 + V_RLOC40 * TX50 / 100) + arr(V_RLOC20 + V_RLOC35 * TX60 / 100) + arr(V_RLOC54 + V_RLOC82 * TX50 / 100) + arr(V_RLOC47 + V_RLOC75 * TX60 / 100) + arr(V_RLOC27 + V_RLOC42 * 5263 / 10000) + arr(V_RLOC22 + V_RLOC37 * 625 / 1000) + arr(V_RLOC57 + V_RLOC85 * 5263 / 10000) + arr(V_RLOC50 + V_RLOC78 * 625 / 1000) + arr(V_RLOC11 + V_RLOC17 * TX50 / 100) + arr(V_RLOC09 + V_RLOC15 * 60 / 100) + arr(V_RLOC26 + V_RLOC41 * 50 / 100) + arr(V_RLOC21 + V_RLOC36 * 60 / 100) + arr(V_RLOC55 + V_RLOC83 * 50 / 100) + arr(V_RLOC48 + V_RLOC76 * 60 / 100) + arr(V_RLOC28 + V_RLOC43 * 5263 / 10000) + arr(V_RLOC23 + V_RLOC38 * 625 / 1000) + arr(V_RLOC58 + V_RLOC86 * 5263 / 10000) + arr(V_RLOC51 + V_RLOC79 * 625 / 1000) + arr(V_RLOC95 + V_RLOC115 * 5263 / 10000) + arr(V_RLOC89 + V_RLOC113 * 625 / 1000) + arr(V_RLOC97 + V_RLOC121 * 5263 / 10000) + arr(V_RLOC91 + V_RLOC117 * 625 / 1000) + arr(V_RLOC29 + V_RLOC44 * 5263 / 10000) + arr(V_RLOC24 + V_RLOC39 * 625 / 1000) + arr(V_RLOC56 + V_RLOC84 * 5263 / 10000) + arr(V_RLOC49 + V_RLOC77 * 625 / 1000) + arr(V_RLOC59 + V_RLOC87 * 5263 / 10000) + arr(V_RLOC52 + V_RLOC80 * 625 / 1000) + arr(V_RLOC96 + V_RLOC116 * 5263 / 10000) + arr(V_RLOC90 + V_RLOC114 * 625 / 1000) + arr(V_RLOC98 + V_RLOC122 * 5263 / 10000) + arr(V_RLOC92 + V_RLOC118 * 625 / 1000) + arr(V_RLOC60 + V_RLOC88 * 5263 / 10000) + arr(V_RLOC53 + V_RLOC81 * 625 / 1000) + arr(V_RLOC99 + V_RLOC123 * 5263 / 10000) + arr(V_RLOC93 + V_RLOC119 * 625 / 1000) + arr(V_RLOC100 + V_RLOC124 * 5263 / 10000) + arr(V_RLOC94 + V_RLOC120 * 625 / 1000) * 1 - V_CNR
