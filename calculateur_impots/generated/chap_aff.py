...
# Original files are "chap-aff.json" and "chap-aff.m"
...
LIG10P = positif_ou_nul(somme((TSBN(i) + PRB(i) for i in interval(1, 4))) + positif(F10AP * null(somme((TSBN(i) + PRB(i) for i in interval(1, 4))))))
...
LIG899 = positif(RVTOT + LIG1100 + LIG910 + BRCMQ + RCMFR + REPRCM + LIGRCMABT + LIG2RCMABT + LIGPV3VG + LIGPV3WB + LIGPV3VE + RCMLIB + LIG29 + LIG30 + RFQ + __2REVF + __3REVF + LIG1130 + VLHAB + DFANT + ESFP + RE168 + TAX1649 + R1649 + PREREV) * 1 - positif(LIG0010 + LIG0020 + LIG0030 + LIG0040 + LIG0050 + LIG0060 + LIG0070) * 1 - ART1731BIS


LIG900 = positif(RVTOT + LIG1100 + LIG910 + BRCMQ + RCMFR + REPRCM + LIGRCMABT + LIG2RCMABT + LIGPV3VG + LIGPV3WB + LIGPV3VE + RCMLIB + LIG29 + LIG30 + RFQ + __2REVF + __3REVF + LIG1130 + VLHAB + DFANT + ESFP + RE168 + TAX1649 + R1649 + PREREV) * positif(LIG0010 + LIG0020 + LIG0030 + LIG0040 + LIG0050 + LIG0060 + LIG0070) * 1 - ART1731BIS


LIG899YT = positif(RVTOT + LIG1100 + LIG910 + BRCMQ + RCMFR + REPRCM + LIGRCMABT + LIG2RCMABT + LIGPV3VG + LIGPV3WB + LIGPV3VE + RCMLIB + LIG29 + LIG30 + RFQ + __2REVF + __3REVF + LIG1130 + VLHAB + DFANT + ESFP + RE168 + TAX1649 + R1649 + PREREV) * 1 - positif(LIG10YT + LIG20YT + LIG30YT + LIG40YT + LIG50YT + LIG60YT + LIG70YT) * ART1731BIS


LIG900YT = positif(RVTOT + LIG1100 + LIG910 + BRCMQ + RCMFR + REPRCM + LIGRCMABT + LIG2RCMABT + LIGPV3VG + LIGPV3WB + LIGPV3VE + RCMLIB + LIG29 + LIG30 + RFQ + __2REVF + __3REVF + LIG1130 + VLHAB + DFANT + ESFP + RE168 + TAX1649 + R1649 + PREREV) * positif(LIG10YT + LIG20YT + LIG30YT + LIG40YT + LIG50YT + LIG60YT + LIG70YT) * ART1731BIS
...
LIG13 = positif(present(BACDEV) + present(BACREV) + present(BAHDEV) + present(BAHREV) + present(BACDEC) + present(BACREC) + present(BAHDEC) + present(BAHREC) + present(BACDEP) + present(BACREP) + present(BAHDEP) + present(BAHREP) + present(__4BAHREV) + present(__4BAHREC) + present(__4BAHREP) + present(__4BACREV) + present(__4BACREC) + present(__4BACREP) + present(BAFV) + present(BAFC) + present(BAFP) + present(BAFORESTV) + present(BAFORESTC) + present(BAFORESTP) + present(BAFPVV) + present(BAFPVC) + present(BAFPVP)) * 1 - positif(IPVLOC) * 1 - positif(ANNUL2042) * LIG1

__4BAQLV = positif(__4BACREV + __4BAHREV)


__4BAQLC = positif(__4BACREC + __4BAHREC)


__4BAQLP = positif(__4BACREP + __4BAHREP)
...
LIG134 = positif(LIG134V + LIG134C + LIG134P + present(DAGRI6) + present(DAGRI5) + present(DAGRI4) + present(DAGRI3) + present(DAGRI2) + present(DAGRI1)) * 1 - positif(IPVLOC) * 1 - positif(abs(DEFIBA)) * 1 - positif(ANNUL2042) * LIG1


LIGDBAIP = positif_ou_nul(DBAIP) * positif(DAGRI1 + DAGRI2 + DAGRI3 + DAGRI4 + DAGRI5 + DAGRI6) * 1 - positif(IPVLOC) * positif(abs(abs(BAHQTOT) + abs(BAQTOT) - DAGRI6 + DAGRI5 + DAGRI4 + DAGRI3 + DAGRI2 + DAGRI1)) * LIG1

LIG136 = positif(__4BAQV + __4BAQC + __4BAQP) * 1 - positif(IPVLOC) * 1 - positif(ANNUL2042) * LIG1

LIG_BICP = LIG_BICPV + LIG_BICPC + LIG_BICPP


LIG_DEFNPI = positif(present(DEFBIC6) + present(DEFBIC5) + present(DEFBIC4) + present(DEFBIC3) + present(DEFBIC2) + present(DEFBIC1)) * LIG0 * LIG2


LIGMLOC = positif(present(MIBMEUV) + present(MIBMEUC) + present(MIBMEUP) + present(MIBGITEV) + present(MIBGITEC) + present(MIBGITEP) + present(LOCGITV) + present(LOCGITC) + present(LOCGITP)) * LIG0 * LIG2
...
LIGPLOC = positif(LOCPROCGAV + LOCPROCGAC + LOCPROCGAP + LOCDEFPROCGAV + LOCDEFPROCGAC + LOCDEFPROCGAP + LOCPROV + LOCPROC + LOCPROP + LOCDEFPROV + LOCDEFPROC + LOCDEFPROP) * 1 - null(4 - V_REGCO) * LIG0


LIGNPLOC = positif(LOCNPCGAV + LOCNPCGAC + LOCNPCGAPAC + LOCDEFNPCGAV + LOCDEFNPCGAC + LOCDEFNPCGAPAC + LOCNPV + LOCNPC + LOCNPPAC + LOCDEFNPV + LOCDEFNPC + LOCDEFNPPAC + LOCGITCV + LOCGITCC + LOCGITCP + LOCGITHCV + LOCGITHCC + LOCGITHCP) * 1 - null(4 - V_REGCO) * LIG0


LIGNPLOCF = positif(LOCNPCGAV + LOCNPCGAC + LOCNPCGAPAC + LOCDEFNPCGAV + LOCDEFNPCGAC + LOCDEFNPCGAPAC + LOCNPV + LOCNPC + LOCNPPAC + LOCDEFNPV + LOCDEFNPC + LOCDEFNPPAC + LNPRODEF10 + LNPRODEF9 + LNPRODEF8 + LNPRODEF7 + LNPRODEF6 + LNPRODEF5 + LNPRODEF4 + LNPRODEF3 + LNPRODEF2 + LNPRODEF1 + LOCGITCV + LOCGITCC + LOCGITCP + LOCGITHCV + LOCGITHCC + LOCGITHCP) * 1 - null(4 - V_REGCO) * LIG0
...
def LIG_BICP(i):
    if i in ('V', 'C', 'P'):
        return present(BICNO(i)) + present(BICDN(i)) + present(BIHNO(i)) + present(BIHDN(i)) * 1 - positif(ANNUL2042) * LIG0
    else:
        raise NotImplementedError()

LIG_BICNPF = positif(present(BICDEC) + present(BICDEP) + present(BICDEV) + present(BICHDEC) + present(BICHDEP) + present(BICHDEV) + present(BICHREC) + present(BICHREP) + present(BICHREV) + present(BICREC) + present(BICREP) + present(BICREV) + present(DEFBIC6) + present(DEFBIC5) + present(DEFBIC4) + present(DEFBIC3) + present(DEFBIC2) + present(DEFBIC1)) * LIG0 * LIG2
...
LIGDAB = positif(present(DABNCNP6) + present(DABNCNP5) + present(DABNCNP4) + present(DABNCNP3) + present(DABNCNP2) + present(DABNCNP1)) * LIG0 * LIG2
...
LIG52 = positif(present(CHENF1) + present(CHENF2) + present(CHENF3) + present(CHENF4) + present(NCHENF1) + present(NCHENF2) + present(NCHENF3) + present(NCHENF4)) * LIG1 * LIG2
...
LIG81 = positif(present(RDDOUP) + present(DONAUTRE) + present(REPDON03) + present(REPDON04) + present(REPDON05) + present(REPDON06) + present(REPDON07) + present(COD7UH) + positif(EXCEDANTA)) * LIG1 * LIG2

LIG1500 = positif(positif(IPMOND) * positif(present(IPTEFP) + positif(VARIPTEFP) * present(DEFZU)) + positif(INDTEFF) * positif(TEFFREVTOT)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * 1 - positif(DEFRIMOND) * LIG1 * LIG2


LIG1510 = positif(positif(IPMOND) * present(IPTEFN) + positif(INDTEFF) * 1 - positif(TEFFREVTOT)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * 1 - positif(DEFRIMOND) * LIG1 * LIG2


LIG1500YT = positif(positif(IPMOND) * positif(present(IPTEFP) + positif(VARIPTEFP) * present(DEFZU)) + positif(INDTEFF) * positif(TEFFREVTOT)) * positif(positif(max(0, IPTEFP + DEFZU - IPTEFN)) + positif(max(0, RMOND + DEFZU - DMOND))) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * positif(DEFRIMOND) * LIG1 * LIG2
...
LIG98B = positif(LIG80 + LIGFIPC + LIGFIPDOM + present(DAIDE) + LIGDUFLOT + LIGPINEL + LIG7CY + LIGREDAGRI + LIGFORET + LIGRESTIMO + LIGCINE + LIGRSOCREPR + LIGCOTFOR + present(PRESCOMP2000) + present(RDPRESREPORT) + present(FCPI) + present(DSOUFIP) + LIGRIRENOV + present(DFOREST) + present(DHEBE) + present(DSURV) + LIGLOGDOM + LIGREPTOUR + LIGLOCHOTR + LIGREPHA + LIGCREAT + LIG1780 + LIG2040 + LIG81 + LIGLOGSOC + LIGDOMSOC1 + somme((LIGCELL(i) for i in ('A', 'B', 'E', 'M', 'C', 'D', 'S', 'F', 'Z', 'N', 'T', 'X'))) + LIGCELMG + LIGCELMH + somme((LIGCELH(i) for i in ('A', 'B', 'D', 'E', 'F', 'H', 'G', 'L', 'M', 'S', 'R', 'U', 'T', 'Z', 'X', 'W', 'V'))) + somme((LIGCELG(i) for i in ('U', 'X', 'T', 'S', 'W', 'P', 'L', 'V', 'K', 'J'))) + somme((LIGCELY(i) for i in ('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L'))) + LIGCELHNO + LIGCELHJK + LIGCELNQ + LIGCELCOM + LIGCELNBGL + LIGCEL + LIGCELJP + LIGCELJBGL + LIGCELJOQR + LIGCEL2012 + LIGCELFD + LIGCELFABC + LIGILMPA + LIGILMPB + LIGILMPC + LIGILMPD + LIGILMPE + LIGILMOA + LIGILMOB + LIGILMOC + LIGILMOD + LIGILMOE + LIGREDMEUB + LIGREDREP + LIGILMIX + LIGILMIY + LIGINVRED + LIGILMIH + LIGILMJC + LIGILMIZ + LIGILMJI + LIGILMJS + LIGMEUBLE + LIGPROREP + LIGREPNPRO + LIGMEUREP + LIGILMIC + LIGILMIB + LIGILMIA + LIGILMJY + LIGILMJX + LIGILMJW + LIGILMJV + LIGRESIMEUB + LIGRESINEUV + LIGRESIVIEU + LIGLOCIDEFG + LIGCODJTJU + LIGCODOU + present(DNOUV) + LIGLOCENT + LIGCOLENT + LIGRIDOMPRO + LIGPATNAT1 + LIGPATNAT2 + LIGPATNAT3 + LIGPATNAT4) * LIG1 * LIG2
...
LIGHABPRIN = positif(present(PREHABT) + present(PREHABT1) + present(PREHABT2) + present(PREHABTN) + present(PREHABTN1) + present(PREHABTN2) + present(PREHABTVT)) * LIG1 * LIG2
...
LIGDEG = positif_ou_nul(TOTIRPSANT) * positif(SEUIL_8 - RECUM) * positif(null(V_NOTRAIT - 23) + null(V_NOTRAIT - 33) + null(V_NOTRAIT - 43) + null(V_NOTRAIT - 53) + null(V_NOTRAIT - 63))


LIGRES = 1 - positif(TOTIRPSANT + 0) * positif_ou_nul(RECUM - SEUIL_8) * positif(null(V_NOTRAIT - 23) + null(V_NOTRAIT - 33) + null(V_NOTRAIT - 43) + null(V_NOTRAIT - 53) + null(V_NOTRAIT - 63))


LIGDEGRES = positif(TOTIRPSANT + 0) * positif_ou_nul(RECUM - SEUIL_8) * positif(null(V_NOTRAIT - 23) + null(V_NOTRAIT - 33) + null(V_NOTRAIT - 43) + null(V_NOTRAIT - 53) + null(V_NOTRAIT - 63))
...
LIGTAXANT = APPLI_ILIAD * 1 - positif(20 - V_NOTRAIT) * positif(V_TAXANT + LIGTAXANET * positif(TAXANET)) * 1 - positif(LIG2051) * TYPE2 * 1 - APPLI_OCEANS


LIGPCAPANT = APPLI_ILIAD * 1 - positif(20 - V_NOTRAIT) * positif(V_PCAPANT + LIGPCAPNET * positif(PCAPNET)) * 1 - positif(LIG2051) * TYPE2 * 1 - APPLI_OCEANS


LIGLOYANT = APPLI_ILIAD * 1 - positif(20 - V_NOTRAIT) * positif(V_TAXLOYANT + LIGLOYNET * positif(TAXLOYNET)) * 1 - positif(LIG2051) * TYPE2 * 1 - APPLI_OCEANS


LIGHAUTANT = APPLI_ILIAD * 1 - positif(20 - V_NOTRAIT) * positif(V_CHRANT + LIGHAUTNET * positif(HAUTREVNET)) * 1 - positif(LIG2051) * TYPE2 * 1 - APPLI_OCEANS
...
LIG2140 = (1 - INDCTX * INDREV1A8 * 1 - positif(IRANT) * null(NAPT) * LIG2 + null(IINET + NAPTOTA) * null(INDREV1A8) * positif(IND_REV) * positif(20 - V_NOTRAIT)) if (V_CR2 + 0 == 0 and NATIMP == 1 and IRNET + TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET + NRINET - NAPTOTA + NAPCR >= SEUIL_12 or V_CR2 + 0 == 1 and NATIMP == 1 or NATIMP == 0 or V_REGCO + 0 == 3 and NRINET + 0 < 12 and CSTOTSSPENA < 61 and LIG2141 + 0 == 0) else 0


LIG21401 = (1 - INDCTX * INDREV1A8 * 1 - positif(IRANT) * null(NAPT) * LIG2 + null(IINET + NAPTOTA) * null(INDREV1A8) * positif(IND_REV) * positif(20 - V_NOTRAIT)) if (V_CR2 + 0 == 0 and NATIMP == 1 and IRNET + TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET + NRINET - NAPTOTA + NAPCR >= SEUIL_12 or V_CR2 + 0 == 1 and NATIMP == 1 or NATIMP == 0 and LIG2141 + 0 == 0) else 0


LIG21402 = (1 - INDCTX * INDREV1A8 * 1 - positif(IRANT) * null(NAPT) * LIG2 + null(IINET + NAPTOTA) * null(INDREV1A8) * positif(IND_REV) * positif(V_NOTRAIT - 20)) if (V_CR2 + 0 == 0 and NATIMP == 1 and IRNET + TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET + NRINET - NAPTOTA + NAPCR >= SEUIL_12 or V_CR2 + 0 == 1 and NATIMP == 1 or NATIMP == 0 and LIG2141 + 0 == 0) else 0

LIG2141 = null(IAN + RPEN - IAVT + TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES - IRANT) * positif(IRANT) * 1 - positif(LIG2501) * null(V_IND_TRAIT - 4) * 1 - positif(NRINET + 0)
...
LIG2150 = 1 - INDCTX * positif(IREST) * 1 - positif(LIG2140) * 1 - positif(IND_REST50) * positif(20 - V_NOTRAIT) * LIG2

LIG2161 = INDCTX * positif(IREST) * positif_ou_nul(IREST - SEUIL_8) * 1 - positif(IND_REST50)


LIG2368 = INDCTX * positif(IREST) * positif(positif(IND_REST50) + positif(IDEGR))

LIG2171 = 1 - INDCTX * positif(IREST) * 1 - positif(LIG2140) * positif(IND_REST50) * positif(20 - V_NOTRAIT) * LIG2

LIGTROP = positif(V_ANTRE + V_ANTCR) * null(IINET) * positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT) * 1 - positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT - SEUIL_12) * null(IDRS2 - IDEC + IREP) * 1 - LIGPS * 1 - INDCTX


LIGTROPS = positif(V_ANTRE + V_ANTCR) * null(IINET) * positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT) * 1 - positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT - SEUIL_12) * null(IDRS2 - IDEC + IREP) * LIGPS * 1 - INDCTX


LIGTROPREST = positif(V_ANTRE + V_ANTCR) * null(IINET) * positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT) * 1 - positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT - SEUIL_12) * 1 - positif(LIGTROP) * 1 - LIGPS * 1 - INDCTX


LIGTROPRESTS = positif(V_ANTRE + V_ANTCR) * null(IINET) * positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT) * 1 - positif_ou_nul(abs(NAPTOTA) - IRESTIT - IRANT - SEUIL_12) * 1 - positif(LIGTROP) * LIGPS * 1 - INDCTX

LIGRESINF50 = positif(positif(IND_REST50) * positif(IREST) + positif(RECUM) * 1 - positif_ou_nul(RECUM - SEUIL_8)) * positif(SEUIL_8 - IRESTIT) * null(LIGRESINF)
...
IND_IRINF80 = (1 - positif(INDCTX) * 1 - positif(IREST)) if (CODINI + 0 == 9 and NATIMP + 0 == 0 or CODINI + 0 == 99 and V_CR2 == 0 and IRNET + TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES + NAPCR < SEUIL_12 and IAVIM + NAPCRPAVIM >= SEUIL_61) else 0

LIGNIIR = null(IRNETBIS) * null(NRINET + 0) * null(NATIMP + 0) * null(TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET + NAPCRP + 0) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - positif(IRESTIT) * 1 - positif(IDEGR) * 1 - positif(LIGIDB) * 1 - positif(LIGNIRI) * 1 - positif(LIG80F) * 1 - positif(LIG400RI) * 1 - positif(LIG400F) * 1 - positif(LIGAUCUN) * 1 - positif(LIG2141) * 1 - positif(LIG2501) * 1 - positif(LIG8FV) * 1 - positif(LIGNIDB) * 1 - null(V_REGCO - 2 + 0) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * positif(20 - V_NOTRAIT) * LIG2


LIGNIIRDEG = null(IDRS3 - IDEC) * null(IBM23) * 1 - positif(IRE) * null(TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES + NAPCRP) * 1 - null(V_REGCO - 2) * 1 - positif(LIG2501) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET - SEUIL_12) * 1 - positif(NRINET - SEUIL_12) * positif(1 + null(3 - INDIRPS)) * positif(V_NOTRAIT - 20) * LIG2

LIGCBAIL = null(IDOM11 - DEC11) * 1 - positif(IBM23) * positif_ou_nul(TAXASSUR + IPCAPTAXTOT + TAXLOY + CHRAPRES + NAPCRP - SEUIL_61) * positif_ou_nul(NAPTIR + NAPCRP - SEUIL_12) * 1 - positif(LIGNIDB) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * 1 - null(V_REGCO - 2) * LIG2


LIGNITSUP = positif_ou_nul(TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES - SEUIL_61) * null(IDRS2 - IDEC + IREP) * positif_ou_nul(TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET - SEUIL_12) * 1 - positif(LIG0TSUP) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(V_NOTRAIT - 20) * 1 - positif(INDCTX) * LIG2


LIGNITDEG = positif(TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET) * positif_ou_nul(IRB2 - SEUIL_61) * positif_ou_nul(TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET - SEUIL_12) * null(INDNIRI) * 1 - positif(IBM23) * positif(1 - null(2 - V_REGCO)) * INDREV1A8 * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * positif(INDCTX) * LIG2

LIGNIDB = null(IDOM11 - DEC11) * positif(SEUIL_61 - TAXASSUR - IPCAPTAXTOT - TAXLOY - CHRAPRES) * positif(SEUIL_61 - NAPCRP) * positif(TAXASSUR + IPCAPTAXTOT + TAXLOY + CHRAPRES + NAPCRP) * null(IRNETBIS) * 1 - positif(IRESTIT) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - positif(LIG80F) * 1 - positif(LIG400RI) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(NRINET) * 1 - positif(IMPRET) * 1 - null(V_REGCO - 2) * LIG2


LIGREVSUP = INDREV1A8 * positif(REVFONC) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * positif(V_NOTRAIT - 20) * 1 - positif(INDCTX) * LIG2


LIGREVDEG = INDREV1A8 * positif(REVFONC) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * positif(INDCTX) * LIG2

LIGNIRI = INDNIRI * null(IRNETBIS) * null(NATIMP) * null(NAPCRP) * 1 - positif(IRE) * 1 - positif(LIGIDB) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - positif(AVFISCOPTER) * 1 - null(V_REGCO - 2) * 1 - positif(TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * positif(20 - V_NOTRAIT) * LIG2

LIGIDB = INDNIRI * null(IBM23) * positif(TAXASSUR + IPCAPTAXTOT + TAXLOY + CHRAPRES + NAPCRP) * positif(SEUIL_61 - TAXASSUR - IPCAPTAXTOT - TAXLOY - CHRAPRES) * positif(SEUIL_61 - NAPCRP) * 1 - positif(IRESTIT) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * LIG2

LIGRIDB = positif(INDNIRI * null(IBM23) * positif_ou_nul(TAXASSUR + IPCAPTAXTOT + TAXLOY + CHRAPRES - SEUIL_61) + positif_ou_nul(NAPCRP - SEUIL_61) * positif_ou_nul(NAPTIR + NAPCRP - SEUIL_12) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * LIG2)


LIG0TSUP = INDNIRI * null(IRNETBIS) * positif_ou_nul(TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES - SEUIL_61) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(V_NOTRAIT - 20) * 1 - positif(INDCTX) * LIG2


LIG0TDEG = INDNIRI * null(IRNETBIS) * positif_ou_nul(TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES - SEUIL_61) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(INDCTX) * LIG2

LIGPSNIR = positif(IAVIM) * positif(SEUIL_61 - IAVIM) * positif(SEUIL_61 - NAPTIR) * positif_ou_nul(NAPCRP - SEUIL_61) * positif(IINET) * positif(20 - V_NOTRAIT) + positif(V_NOTRAIT - 20) * 1 - positif(LIG400RI) * 1 - null(V_REGCO - 2) * 1 - positif(LIGNIDB) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * LIG2


LIGIRNPS = positif(positif_ou_nul(IAVIM - SEUIL_61) * positif_ou_nul(NAPTIR - SEUIL_12) * positif(IBM23) + positif(IRESTIT + 0)) * positif(SEUIL_61 - NAPCRP) * positif(NAPCRP) * 1 - positif(LIG400RI) * 1 - null(V_REGCO - 2) * 1 - positif(LIGNIDB) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * LIG2


LIG400F = INDNMR1 * positif(IAMD2) * 1 - INDNIRI * positif_ou_nul(NAPTIR) * 1 - positif(LIG400RI) * 1 - null(V_REGCO - 2) * 1 - positif(LIGNIDB) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * positif(20 - V_NOTRAIT) * LIG2


LIG400DEG = positif(IAVIM + NAPCRPAVIM) * positif(SEUIL_61 - IAVIM + NAPCRPAVIM) * null(ITRED) * positif(IRNET) * 1 - positif(IRNET - SEUIL_61) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET - SEUIL_12) * 1 - positif(NRINET - SEUIL_12) * positif(V_NOTRAIT - 20) * LIG2

LIG400RI = INDNMR1 * positif(ITRED) * 1 - null(IRB) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(20 - V_NOTRAIT) * LIG2


LIG61NRSUP = positif(IBM23) * positif(ITRED) * positif(IAVIM + NAPCRPAVIM) * positif(SEUIL_61 - IAVIM + NAPCRPAVIM) * 1 - positif(INDNMR2) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * positif(V_NOTRAIT - 20) * LIG2


LIG61DEG = positif(ITRED) * positif(IAVIM) * positif(SEUIL_61 - IAVIM) * 1 - positif(INDNMR2) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * positif(INDCTX) * LIG2

LIG80F = positif(positif(SEUIL_12 - NAPTIR) * positif(NAPTIR) * positif(SEUIL_61 - NAPCRP) * positif_ou_nul(IAVIM - SEUIL_61) + positif(SEUIL_12 - NAPCRP + NAPTIR) * positif(NAPCRP + NAPTIR) * positif_ou_nul(NAPCRP - SEUIL_61) * 1 - positif(IRANT) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(20 - V_NOTRAIT) * 1 - null(V_REGCO - 2) * LIG2)

LIGAUCUN = positif(positif_ou_nul(IAVIM - SEUIL_61) + positif_ou_nul(NAPCRP - SEUIL_61) * null(TOTNET) * null(NAPT) * 1 - positif(IREST) * 1 - positif(LIG80F) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * 1 - positif(NRINET) * 1 - null(V_REGCO - 2) * positif(20 - V_NOTRAIT) * LIG2)

LIG12ANT = positif(IRANT) * positif(SEUIL_12 - TOTNET) * positif(TOTNET) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(null(2 - V_REGCO) + 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)) * positif(NRINET - SEUIL_12) * 1 - positif(IMPRET - SEUIL_12) * 1 - positif(NRINET - SEUIL_12) * positif(20 - V_NOTRAIT) * LIG2

LIG12NMR = positif(IRPSCUM) * positif(SEUIL_12 - IRPSCUM) * positif(V_NOTRAIT - 20) * 1 - null(2 - V_REGCO) * 1 - positif(IMPRET - SEUIL_12) * 1 - positif(NRINET - SEUIL_12)

LIGNIIRAF = null(IAD11) * positif(IRESTIT) * 1 - positif(INDNIRI) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - positif_ou_nul(NAPTIR) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(1 + null(3 - INDIRPS)) * LIG2

LIGNIRIAF = INDNIRI * null(IBM23) * positif(positif(IRESTIT) + positif(V_NOTRAIT - 20)) * 1 - positif(LIGIDB) * 1 - positif(LIGRIDB) * 1 - positif(IREP) * 1 - positif(IPROP) * 1 - positif(IMPRET) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * LIG2

LIGNIDEG = null(IDRS3 - IDEC) * null(IBM23) * positif(SEUIL_61 - TAXASSUR) * positif(SEUIL_61 - IPCAPTAXT) * positif(SEUIL_61 - TAXLOY) * positif(SEUIL_61 - CHRAPRES) * positif(SEUIL_12 - IRNET) * 1 - null(V_REGCO - 2) * 1 - positif(LIGDEG61) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * positif(INDCTX) * LIG2

LIGDEG61 = positif(IRNETBIS) * positif(SEUIL_61 - IAMD1) * positif(SEUIL_61 - NRINET) * positif(IBM23) * 1 - positif(LIG61DEG) * 1 - null(V_REGCO - 2) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * positif(INDCTX) * LIG2

LIGDEG12 = positif(IRNET + TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET) * positif(SEUIL_12 - IRNET - TAXANET - PCAPNET - TAXLOYNET - HAUTREVNET) * 1 - null(V_REGCO - 2) * 1 - positif(LIGNIDEG) * 1 - positif(LIGDEG61) * 1 - positif(LIG61DEG) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - positif(IMPRET) * positif(INDCTX) * LIG2

LIGDIPLOI = positif(INDREV1A8) * positif(null(NATIMP - 1) + positif(NAPTEMP)) * positif(REVFONC) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * LIG1

LIGDIPLONI = positif(INDREV1A8) * positif(null(NATIMP) + positif(IREST) + 1 - positif(NAPTEMP)) * positif(REVFONC) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * 1 - positif(LIGTROP) * 1 - positif(LIGTROPREST) * 1 - LIGDIPLOI * LIG1

LIG2355 = positif(IND_NI * 1 - positif(V_ANTRE) + INDNMR1 + INDNMR2 + positif(NAT1BIS) * null(NAPT) * positif(IRNET + TAXANET + PCAPNET + TAXLOYNET + HAUTREVNET) + positif(SEUIL_12 - IAN + RPEN - IAVT + TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES - IRANT) * positif_ou_nul(IAN + RPEN - IAVT + TAXASSUR + IPCAPTAXT + TAXLOY + CHRAPRES - IRANT)) * positif(INDREV1A8) * 1 - null(NATIMP - 1) + null(NATIMP - 1) * positif(IRANT) * 1 - LIGPS * LIG2
...
LIG2380 = (IND_SPR * positif_ou_nul(V_8ZT - RBG) * positif(V_8ZT) * 1 - present(BRAS) * 1 - present(IPSOUR) * V_CR2 * LIG2) if (NATIMP == 0 or NATIMP == 21 or NATIMP == 70 or NATIMP == 91) else 0

LIG2383 = (positif(RBG - V_8ZT) * present(IPSOUR) * V_CR2 * LIG2) if (IAVIM + NAPCRPAVIM <= IPSOUR * LIG1) else 0
...
LIG2503 = 1 - positif(IND_REV) * 1 - positif_ou_nul(IND_TDR) * LIG2 * 1 - null(2 - V_REGCO)

LIG3510 = positif(V_FORVA) * 1 - positif_ou_nul(BAFV) + positif(V_FORCA) * 1 - positif_ou_nul(BAFC) + positif(V_FORPA) * 1 - positif_ou_nul(BAFP) * 1 - positif(IPVLOC) * LIG1
...
LIG3730 = 1 - positif(20 - V_NOTRAIT) * positif(BOOL_0AZ) * LIG1
...
LIG022 = somme((TSNN2(i)AFF for i in interval(1, 4)))

LIG023 = somme((__3TSN(i) for i in interval(1, 4)))

LIG024 = somme((__4TSN(i) for i in interval(1, 4)))
...
LIG062P = somme((CARPEP(i) + CARPENBAP(i) for i in interval(1, 4))) + somme((PENSALP(i) + PENSALNBP(i) for i in interval(1, 4))) + CODRCZ + CODRDZ + CODREZ + CODRFZ

LIG066 = somme((PEBF(i) for i in interval(1, 4)))
...
LIG_SALASS = positif(TSBNV + TSBNC + TSBNP + F10AV + F10AC + F10AP + null(ALLOV + ALLOC + ALLOP) * null(TSHALLOV + TSHALLOC + TSHALLOP)) * LIG0 * LIG2
...
LIGRCMABT = positif(present(RCMABD) + present(RCMTNC) + present(RCMHAD) + present(RCMHAB) + present(RCMAV) + present(REGPRIV) + present(RCMFR) + present(DEFRCM) + present(DEFRCM2) + present(DEFRCM3) + present(DEFRCM4) + present(DEFRCM5) + present(DEFRCM6)) * 1 - positif(IPVLOC) * LIG1 * LIG2 * positif(INDREV1A8IR)


LIG2RCMABT = positif(present(REVACT) + present(REVPEA) + present(PROVIE) + present(DISQUO) + present(RESTUC) + present(INTERE)) * 1 - positif(IPVLOC) * LIG1 * LIG2 * positif(INDREV1A8IR)
...
INDPPEP = positif(somme((PPETPP(i) for i in interval(1, 4))) * PPESALPTOT + somme((PPENBH(i) for i in interval(1, 4))) * PPESALPTOT + PPEACP + PPENJP * abs(PPERPROP) * null(TSHALLO1 + TSHALLO2 + TSHALLO3 + TSHALLO4 + 0) + positif(somme((PPETPP(i) + PPENBH(i) + 0 for i in interval(1, 4)))) + somme((present(CARTSP(i)) * present(CARTSNBAP(i)) for i in interval(1, 4))) * PPEPRIMEPT + abs(PPERPROP) * PPEPRIMEPT)
...
def PPESAISITP(i):
    if i in ('V', 'C', 'P'):
        return positif(PPEAC(i) * positif(abs(PPERPRO(i))))
    else:
        raise NotImplementedError()
...
def PPESAISINBJ(i):
    if i in ('V', 'C', 'P'):
        return positif(PPENJ(i) * positif(abs(PPERPRO(i))))
    else:
        raise NotImplementedError()

LIGPIPPE = positif(PPETOTX) * LIG0

PPEREVSALV = positif(PPESALVTOT * INDLIGPPE + PPESALV * positif(PPEPRIMEVT) * positif(PPETOTX)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * INDPPEV * INDLIGPPE


PPEREVSALC = positif(PPESALCTOT * INDLIGPPE + PPESALC * positif(PPEPRIMECT) * positif(PPETOTX)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * INDPPEC * INDLIGPPE


PPEREVSALP = positif(PPESALPTOT + PPESALPTOT * INDLIGPPE + PPESALPTOT * positif(PPEPRIMEPT) * positif(PPETOTX)) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO) * INDPPEP * INDLIGPPE

TPLEINSALV = positif(PPETPV * PPESALVTOT + positif(PPENBHV - 1820) + PPESALVTOT * INDLIGPPE * 1 - positif(LIGPPEHV) + positif(PPEPRIMEVT) * positif(PPETOTX) * positif(PPESALV) * 1 - positif(LIGPPEHV) + positif(PPESALV) * 1 - positif(LIGPPEHV)) * INDPPEV * positif(INDLIGPPE) * LIG0 * LIG2


TPLEINSALC = positif(PPETPC * PPESALCTOT + PPESALCTOT * INDLIGPPE * 1 - positif(LIGPPEHC) + positif(PPENBHC - 1820) + positif(PPEPRIMECT) * positif(PPETOTX) * positif(PPESALC) * 1 - positif(LIGPPEHC) + positif(PPESALC) * 1 - positif(LIGPPEHC)) * INDPPEC * positif(INDLIGPPE) * LIG0 * LIG2


TPLEINSALP = positif(PPETPP1 + PPETPP2 + PPETPP3 + PPETPP4 * PPESALPTOT + positif(PPENBH1 - 1820) + positif(PPENBH2 - 1820) + positif(PPENBH3 - 1820) + positif(PPENBH4 - 1820) + PPESALPTOT * INDLIGPPE * 1 - positif(LIGPPEHP) + positif(PPEPRIMEPT) * positif(PPETOTX) * positif(PPESALPTOT) * 1 - positif(LIGPPEHP) + positif(PPESALPTOT) * 1 - positif(LIGPPEHP)) * INDPPEP * positif(INDLIGPPE) * LIG0 * LIG2


TPLEINNSALV = positif(positif(PPEACV + positif(PPENJV - 360) + positif(positif(1 - null(PPE_AVRPRO1V + 0)) * positif(positif(PPETOTX) + positif(PPEREVSALV)) * positif(abs(PPERPROV))) * 1 - positif(LIGPPEJV)) * positif(INDLIGPPE) + positif(PPESAISITPV) * positif(PPEACV)) * INDPPEV * LIG0 * LIG2


TPLEINNSALC = positif(positif(PPEACC + positif(PPENJC - 360) + positif(positif(1 - null(PPE_AVRPRO1C + 0)) * positif(positif(PPETOTX) + positif(PPEREVSALC)) * positif(abs(PPERPROC))) * 1 - positif(LIGPPEJC)) * positif(INDLIGPPE) + positif(PPESAISITPC) * positif(PPEACC)) * INDPPEC * LIG0 * LIG2


TPLEINNSALP = positif(positif(PPEACP + positif(PPENJP - 360) + positif(positif(1 - null(PPE_AVRPRO1P + 0)) * positif(positif(PPETOTX) + positif(PPEREVSALP)) * positif(abs(PPERPROP))) * 1 - positif(LIGPPEJP)) * positif(INDLIGPPE) + positif(PPESAISITPP) * positif(PPEACP)) * INDPPEP * LIG0 * LIG2

LIGPPENSV = positif(positif(positif(1 - null(PPE_AVRPRO1V + 0)) * positif(positif(PPETOTX) + positif(PPEREVSALV)) * positif(INDLIGPPE)) + positif(PPESAISITPV + PPESAISINBJV)) * INDPPEV * LIG0 * LIG2


LIGPPENSC = positif(positif(positif(1 - null(PPE_AVRPRO1C + 0)) * positif(positif(PPETOTX) + positif(PPEREVSALC)) * positif(INDLIGPPE)) + positif(PPESAISITPC + PPESAISINBJC)) * INDPPEC * LIG0 * LIG2


LIGPPENSP = positif(positif(positif(1 - null(PPE_AVRPRO1P + 0)) * positif(positif(PPETOTX) + positif(PPEREVSALP)) * positif(INDLIGPPE)) + positif(PPESAISITPP + PPESAISINBJP)) * INDPPEP * LIG0 * LIG2

LIGPPEHV = positif_ou_nul(1820 - PPENBHV) * present(PPENBHV) * INDPPEV * positif(INDLIGPPE) * LIG0 * LIG2


LIGPPEHC = positif_ou_nul(1820 - PPENBHC) * present(PPENBHC) * INDPPEC * positif(INDLIGPPE) * LIG0 * LIG2


LIGPPEHP = positif(positif_ou_nul(1820 - PPENBH1) * present(PPENBH1) + positif_ou_nul(1820 - PPENBH2) * present(PPENBH2) + positif_ou_nul(1820 - PPENBH3) * present(PPENBH3) + positif_ou_nul(1820 - PPENBH4) * present(PPENBH4)) * INDPPEP * positif(INDLIGPPE) * LIG0 * LIG2


LIGPPEJV = positif_ou_nul(360 - PPENJV) * positif(INDLIGPPE) * LIG0 * LIG2 * present(PPENJV) * positif(PPENJV) + positif(PPESAISITPV) * positif(PPEACV)


LIGPPEJC = positif_ou_nul(360 - PPENJC) * positif(INDLIGPPE) * LIG0 * LIG2 * positif(PPENJC) * present(PPENJC) + positif(PPESAISITPC) * positif(PPEACC)


LIGPPEJP = positif_ou_nul(360 - PPENJP) * positif(INDLIGPPE) * LIG0 * LIG2 * positif(PPENJP) * present(PPENJP) + positif(PPESAISITPP) * positif(PPEACP)

LIG_REPORT = positif(LIGRNIDF + somme((LIGRNIDF(i) for i in interval(0, 5))) + LIGDEFBA + LIGDRFRP + LIG3250 + LIGIRECR + LIGDRCVM + LIGDLMRN + LIGBNCDF + somme((LIGMIBDREP(i) + LIGMBDREPNP(i) + LIGSPEDREP(i) + LIGSPDREPNP(i) for i in ('V', 'C', 'P'))) + LIGLOCNEUF + somme((LIGLOCNEUF(i) for i in interval(1, 6))) + LIGPATNATR + LIGRDUFLOTOT + LIGRPINELTOT + LIGRCELFD + LIGRCELFABC + LIGRCEL2012 + LIGRCELJBGL + LIGRCELJOQR + LIGRCELJP + LIGRCEL + LIGRCELNBGL + LIGRCELCOM + LIGRCELNQ + LIGRCELHJK + LIGRCELHNO + LIGRCELHLM + LIGRRCEL1 + LIGRRCEL2 + LIGRRCEL3 + LIGRRCEL4 + LIGRCODOU + LIGRCODJT + LIGRCODJU + LIGRLOCIDFG + LIGREPLOCIE + LIGNEUV + LIGRNEUV + LIGVIEU + LIGCOMP01 + LIGREPQKG + LIGREPQNH + LIGREPQUS + LIGREPQWB + LIGREPMMQE + LIGREPLI + LIGREPMC + LIGREPKU + LIGREPLH + LIGREPMB + LIGREPKT + LIGREPQV + LIGREPQO + LIGREPQP + LIGREPQR + LIGREPQF + LIGREPQG + LIGREPQI + LIGREPPAK + LIGREPPBL + LIGREPPDO + LIGREPPEK + LIGREPPFL + LIGREPPHO + LIGREPPIZ + LIGREPPJA + LIGREPPLB + LIGREPTB + LIGREPPM + LIGREPPN + LIGREPPO + LIGREPPP + LIGREPPR + LIGREPPS + LIGREPPT + LIGREPPU + LIGREPPW + LIGREPPX + LIGREPPY + LIGREPRG + LIGREPRI + LIGREPRM + LIGREPRC + LIGREPRR + LIGREPRUP + LIGREPRVQ + LIGREPRWR + LIGREPRYT + LIGREPNW + LIGREPSA + LIGREPSB + LIGREPSC + LIGREPSE + LIGREPSF + LIGREPSG + LIGREPSH + LIGREPSJ + LIGREPSM + LIGREPSU + LIGREPSV + LIGREPSW + LIGREPSY + LIGREPDOMOUT + LIGPME3 + LIGPME2 + LIGPME1 + LIGPMECU + LIGRSN + LIGRSN2 + LIGRSN1 + LIGRSN0 + LIGPLAFRSN + LIGPLAFRSN4 + LIGPLAFRSN3 + LIGREPDON + LIGREPDONR + LIGREPDONR1 + LIGREPDONR2 + LIGREPDONR3 + LIGREPDONR4 + LIGREPOU + LIGREP7PA + LIGREP7PB + LIGREP7PC + LIGREP7PD + LIGREP7PE + LIGREPDOM + LIGREPNEUV + LIGREPCODJT + LIGREPLOCNT + LIGRESIREP + LIGREPMEU + LIGREPREPAR + LIGLOCRES + LIGDFRCM + LIGPME + LIGREPCORSE + LIGREPRECH + LIGREPCICE + LIGDEFPLOC + LIGFOREST + LIGNFOREST + LIGREP7UP + LIGREP7UA + LIGREP7UT + LIGREP7UB) * LIG2
...
EXOVOUS = present(TSASSUV) + positif(XETRANV) + positif(EXOCETV) + present(FEXV) + positif(MIBEXV) + positif(MIBNPEXV) + positif(BNCPROEXV) + positif(XSPENPV) + positif(XBAV) + positif(XBIPV) + positif(XBINPV) + positif(XBNV) + positif(XBNNPV) + positif(ABICPDECV) * 1 - V_CNR + positif(ABNCPDECV) * 1 - V_CNR + positif(HONODECV) * 1 - V_CNR + positif(AGRIV) + positif(BIPERPV) + positif(BNCCREAV)


EXOCJT = present(TSASSUC) + positif(XETRANC) + positif(EXOCETC) + present(FEXC) + positif(MIBEXC) + positif(MIBNPEXC) + positif(BNCPROEXC) + positif(XSPENPC) + positif(XBAC) + positif(XBIPC) + positif(XBINPC) + positif(XBNC) + positif(XBNNPC) + positif(ABICPDECC) * 1 - V_CNR + positif(ABNCPDECC) * 1 - V_CNR + positif(HONODECC) * 1 - V_CNR + positif(AGRIC) + positif(BIPERPC) + positif(BNCCREAC)


EXOPAC = present(FEXP) + positif(MIBEXP) + positif(MIBNPEXP) + positif(BNCPROEXP) + positif(XSPENPP) + positif(XBAP) + positif(XBIPP) + positif(XBINPP) + positif(XBNP) + positif(XBNNPP) + positif(ABICPDECP) * 1 - V_CNR + positif(ABNCPDECP) * 1 - V_CNR + positif(HONODECP) * 1 - V_CNR + positif(AGRIP) + positif(BIPERPP) + positif(BNCCREAP)

LIGTITREXVCP = positif(EXOVOUS) * positif(EXOCJT) * positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2


LIGTITREXV = positif(EXOVOUS) * 1 - positif(EXOCJT) * 1 - positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2


LIGTITREXC = 1 - positif(EXOVOUS) * positif(EXOCJT) * 1 - positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2


LIGTITREXP = 1 - positif(EXOVOUS) * 1 - positif(EXOCJT) * positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2


LIGTITREXVC = positif(EXOVOUS) * positif(EXOCJT) * 1 - positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2


LIGTITREXVP = positif(EXOVOUS) * 1 - positif(EXOCJT) * positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2


LIGTITREXCP = 1 - positif(EXOVOUS) * positif(EXOCJT) * positif(EXOPAC) * 1 - positif(LIG2501) * LIG1 * LIG2
...
LIGPERP = 1 - positif(PERPIMPATRIE + 0) * positif(PERPINDV + PERPINDC + PERPINDP + PERPINDCV + PERPINDCC + PERPINDCP) * positif(PERPINDAFFV + PERPINDAFFC + PERPINDAFFP) * 1 - null(PERP_COTV + PERP_COTC + PERP_COTP + 0) * 1 - INDIMPOS * 1 - positif(PERP_COND1 + PERP_COND2) * 1 - positif(LIG8FV) * 1 - positif(LIG2501) * LIG1 * 1 - V_CNR * LIG2 + 0


LIGPERPI = positif(PERPIMPATRIE + 0) * positif(PERPINDV + PERPINDC + PERPINDP + PERPINDCV + PERPINDCC + PERPINDCP) * positif(PERPINDAFFV + PERPINDAFFC + PERPINDAFFP) * 1 - null(PERP_COTV + PERP_COTC + PERP_COTP + 0) * 1 - INDIMPOS * 1 - positif(PERP_COND1 + PERP_COND2) * 1 - positif(LIG8FV) * 1 - positif(LIG2501) * LIG1 * 1 - V_CNR * LIG2 + 0


LIGPERPM = 1 - positif(PERPIMPATRIE + 0) * positif(PERPINDV + PERPINDC + PERPINDP + PERPINDCV + PERPINDCC + PERPINDCP) * positif(PERPINDAFFV + PERPINDAFFC + PERPINDAFFP) * 1 - null(PERP_COTV + PERP_COTC + PERP_COTP + 0) * 1 - INDIMPOS * positif(PERP_MUT) * positif(PERP_COND1 + PERP_COND2) * 1 - positif(LIG8FV) * 1 - positif(LIG2501) * LIG1 * 1 - V_CNR * LIG2 + 0


LIGPERPMI = positif(PERPIMPATRIE + 0) * positif(PERPINDV + PERPINDC + PERPINDP + PERPINDCV + PERPINDCC + PERPINDCP) * positif(PERPINDAFFV + PERPINDAFFC + PERPINDAFFP) * 1 - null(PERP_COTV + PERP_COTC + PERP_COTP + 0) * 1 - INDIMPOS * positif(PERP_MUT) * positif(PERP_COND1 + PERP_COND2) * 1 - positif(LIG8FV) * 1 - positif(LIG2501) * LIG1 * 1 - V_CNR * LIG2 + 0


LIGPERPFAM = positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFC) * positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)


LIGPERPV = positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * 1 - positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFC) * 1 - positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)


LIGPERPC = positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFC) * 1 - positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * 1 - positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)


LIGPERPP = positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * 1 - positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * 1 - positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFC) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)


LIGPERPCP = positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFV) * 1 - positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)


LIGPERPVP = positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * 1 - positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFC) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)


LIGPERPMAR = positif(PERPINDV + PERPINDCV) * positif(PERPINDAFFV) * positif(PERPINDC + PERPINDCC) * positif(PERPINDAFFC) * 1 - positif(PERPINDP + PERPINDCP) * positif(PERPINDAFFP) * LIG1 * 1 - V_CNR * LIG2 * positif(LIGPERP + LIGPERPI + LIGPERPM + LIGPERPMI)

ZIG_TITRECRP = positif(BCSG + V_CSANT) * positif(BRDS + V_RDANT) * positif(BPRS + V_PSANT) * 1 - positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * 1 - positif(ZIG_RF + max(0, NPLOCNETSF)) * LIG2


ZIGTITRECRPS = positif(BCSG + V_CSANT) * positif(BRDS + V_RDANT) * positif(BPRS + V_PSANT) * positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * 1 - positif(ZIG_RF + max(0, NPLOCNETSF)) * LIG2


ZIGTITRECRS = positif(BCSG + V_CSANT) * positif(BRDS + V_RDANT) * positif(BCVNSAL + V_CVNANT) * 1 - positif(BPRS + V_PSANT) * 1 - V_CNR * LIG2


ZIGTITRERS = 1 - positif(BCSG + V_CSANT) * positif(BRDS + V_RDANT) * 1 - positif(BPRS + V_PSANT) * positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * LIG2


ZIG_TITRECR = positif(BCSG + V_CSANT) * positif(BRDS + V_RDANT) * 1 - positif(BPRS + V_PSANT) * 1 - positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * LIG2


ZIG_TITRECP = positif(BCSG + V_CSANT) * 1 - positif(BRDS + V_RDANT) * positif(BPRS + V_PSANT) * 1 - positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * LIG2


ZIG_TITRERP = 1 - positif(BCSG + V_CSANT) * positif(BRDS + V_RDANT) * positif(BPRS + V_PSANT) * 1 - positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * LIG2


ZIG_TITREC = positif(BCSG + V_CSANT) * 1 - positif(BRDS + V_RDANT) * 1 - positif(BPRS + V_PSANT) * 1 - positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * LIG2


ZIG_TITRER = positif(BRDS + V_RDANT) * 1 - positif(BCSG + V_CSANT) * 1 - positif(BPRS + V_PSANT) * 1 - positif(BCVNSAL + V_CVNANT) * 1 - V_CNR * LIG2


ZIGTITRES = positif(BCVNSAL + V_CVNANT) * 1 - positif(BRDS + V_RDANT) * 1 - positif(BCSG + V_CSANT) * 1 - positif(BPRS + V_PSANT) * LIG2


ZIG_TITREPN = positif(BPRS + V_PSANT) * 1 - V_CNR * LIG2

ZIGTITRE = positif(positif(BCSG + V_CSANT + BRDS + V_RDANT + BPRS + V_PSANT) * 1 - V_CNR * 1 - positif(ZIG_RF + max(0, NPLOCNETSF)) + positif(BCVNSAL + V_CVNANT + BCDIS + V_CDISANT) * TYPE4) * 1 - positif(ANNUL2042)
...
ZIG_RVTO = positif(CS_RVT + RD_RVT + PS_RVT + IND_ZIGRVT) * 1 - V_CNR * 1 - positif(ANNUL2042) * LIG1 * LIG2 * null(3 - INDIRPS)
...
IND_ZIGRCM = positif(present(RCMABD) + present(RCMAV) + present(RCMHAD) + present(RCMHAB) + present(RCMTNC) + present(RCMAVFT) + present(REGPRIV)) * positif(V_NOTRAIT - 20)


ZIG_RCM = positif(CS_RCM + RD_RCM + PS_RCM + IND_ZIGRCM) * 1 - V_CNR * 1 - positif(ANNUL2042) * LIG1 * LIG2 * null(3 - INDIRPS)
...
IND_ZIGPROF = positif(V_NOTRAIT - 20) * positif(present(RCSV) + present(RCSC) + present(RCSP))


ZIG_PROF = positif(CS_REVCS + RD_REVCS + PS_REVCS + IND_ZIGPROF) * 1 - positif(ANNUL2042) * LIG1 * null(3 - INDIRPS)
...
ZIG_RTF = positif(CS_RTF + RD_RTF + PS_RTF + IND_ZIGRTF) * 1 - V_CNR * 1 - positif(ANNUL2042) * LIG1 * LIG2 * null(3 - INDIRPS)
...
ZIG_REVETR = positif(SALECS + SALECSG + ALLECS + INDECS + PENECS + COD8SA + COD8SB) * 1 - V_CNR * LIG1 * LIG2
...
ZIG_RVORIGND = positif(CS_RVORIGND + RD_RVORIGND + PS_RVORIGND + IND_ZIGREVORIGIND) * 1 - V_CNR * LIG1 * LIG2
...
LIGPS = positif(BCSG + BRDS + BPRS + BCVNSAL + BREGV + BCDIS + BGLOA + BRSE1 + BRSE2 + BRSE3 + BRSE4 + BRSE5 + 0) * 1 - positif(ANNUL2042)
...
INDIRPS = 1 * 1 - LIGPS * positif(3 - ANTINDIRPS) + 3 * 1 - positif(1 - LIGPS * positif(3 - ANTINDIRPS))
...
INDT = positif(IND_COLC + IND_COLR + IND_COLP + IND_COLS + IND_CTXC + IND_CTXR + IND_CTXP + IND_CTXS) * INDTRAIT
...
ZIG_NETAP = positif(BCSG + BRDS + BPRS + BCVNSAL + BREGV + BCDIS + BGLOA + BRSE1 + BRSE2 + BRSE3 + BRSE4 + BRSE5) * LIG2
...
ZIG_REMPLACE = positif(1 - positif(20 - V_NOTRAIT) * positif(V_ANREV - V_0AX) * positif(V_ANREV - V_0AZ) * positif(V_ANREV - V_0AY) + positif(V_NOTRAIT - 20)) * LIG2

ZIG_DEGINF61 = positif(V_CSANT + V_RDANT + V_PSANT + 0) * positif(CRDEG + 0) * positif(SEUIL_61 - TOTCRA - CSNET - RDNET - PRSNET - CDISNET + 0) * 1 - null(CSTOT + 0) * LIG2
...
ZIGRSEDD = positif(V_RSE1ANT + V_RSE2ANT + V_RSE3ANT + V_RSE4ANT + V_RSE5ANT - DRSED) * positif(IDRSE) * 1 - null(V_IDRSEANT + DRSED + 0) * 1 - null(V_IDRSEANT - DRSED) * positif(V_NOTRAIT - 20) * LIG2


ZIGRSERS = positif(DRSED - V_RSE1ANT + V_RSE2ANT + V_RSE3ANT + V_RSE4ANT + V_RSE5ANT) * positif(IDRSE) * 1 - null(V_IDRSEANT + DRSED + 0) * 1 - null(V_IDRSEANT - DRSED) * positif(V_NOTRAIT - 20) * LIG2
...
ANCSDED2 = V_ANCSDED * 1 - null(933 - V_ROLCSG) + V_ANCSDED + 1 * null(933 - V_ROLCSG) * positif(V_ROLCSG + 0) + V_ANCSDED * 1 - positif(V_ROLCSG + 0)
...
LIG_SURSIS = positif(LIGPVSURSI + LIGBPTPGJ + LIGIREXITI + LIGIREXI19 + LIGIREXITS + LIGIREXS19 + LIGIREXIT + LIGEXITAX3 + LIGSURIMP) * LIG1 * LIG2
...
LIGTXMOYPS = positif(TXMOYIMP) * 1 - positif(V_CNR) * 1 - positif(null(2 - V_REGCO) + null(4 - V_REGCO) + positif(present(NRINET) + present(NRBASE) + present(IMPRET) + present(BASRET))) * IND_REV * LIG2 * positif(20 - V_NOTRAIT)
...
LIGRCODJT = positif(LOCMEUBJT + 0) * positif(RCODJT1 + RCODJT2 + RCODJT3 + RCODJT4 + RCODJT5 + RCODJT6 + RCODJT7 + RCODJT8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGRCODJU = positif(LOCMEUBJU + 0) * positif(RCODJU1 + RCODJU2 + RCODJU3 + RCODJU4 + RCODJU5 + RCODJU6 + RCODJU7 + RCODJU8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGRLOCIDFG = positif(LOCMEUBID + LOCMEUBIF + LOCMEUBIG) * positif(RLOCIDFG1 + RLOCIDFG2 + RLOCIDFG3 + RLOCIDFG4 + RLOCIDFG5 + RLOCIDFG6 + RLOCIDFG7 + RLOCIDFG8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGREPLOCIE = positif(LOCMEUBIE) * positif(REPLOCIE1 + REPLOCIE2 + REPLOCIE3 + REPLOCIE4 + REPLOCIE5 + REPLOCIE6 + REPLOCIE7 + REPLOCIE8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGNEUV = positif(LOCRESINEUV + INVNPROF1 + INVNPROF2) * positif(RESINEUV1 + RESINEUV2 + RESINEUV3 + RESINEUV4 + RESINEUV5 + RESINEUV6 + RESINEUV7 + RESINEUV8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGRNEUV = positif(MEUBLENP) * positif(RRESINEUV1 + RRESINEUV2 + RRESINEUV3 + RRESINEUV4 + RRESINEUV5 + RRESINEUV6 + RRESINEUV7 + RRESINEUV8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGVIEU = positif(RESIVIEU) * positif(RESIVIEU1 + RESIVIEU2 + RESIVIEU3 + RESIVIEU4 + RESIVIEU5 + RESIVIEU6 + RESIVIEU7 + RESIVIEU8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGVIAN = positif(RESIVIANT) * positif(RESIVIAN1 + RESIVIAN2 + RESIVIAN3 + RESIVIAN4 + RESIVIAN5 + RESIVIAN6 + RESIVIAN7 + RESIVIAN8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)


LIGMEUB = positif(VIEUMEUB) * positif(RESIMEUB1 + RESIMEUB2 + RESIMEUB3 + RESIMEUB4 + RESIMEUB5 + RESIMEUB6 + RESIMEUB7 + RESIMEUB8) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
LIGDEFBA = positif(DEFBA1 + DEFBA2 + DEFBA3 + DEFBA4 + DEFBA5 + DEFBA6) * LIG1 * 1 - null(4 - V_REGCO) * LIG2
...
LIGDFRCM = positif(DFRCMN + DFRCM1 + DFRCM2 + DFRCM3 + DFRCM4 + DFRCM5) * LIG1 * LIG2 * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)
...
LIGDLMRN = positif(DLMRN6 + DLMRN5 + DLMRN4 + DLMRN3 + DLMRN2 + DLMRN1) * LIG1 * 1 - null(4 - V_REGCO) * LIG2
...
LIGBNCDF = positif(BNCDF1 + BNCDF2 + BNCDF3 + BNCDF4 + BNCDF5 + BNCDF6) * LIG1 * 1 - null(4 - V_REGCO) * LIG2
...
LIGDEFPLOC = positif(DEFLOC1 + DEFLOC2 + DEFLOC3 + DEFLOC4 + DEFLOC5 + DEFLOC6 + DEFLOC7 + DEFLOC8 + DEFLOC9 + DEFLOC10) * LIG1 * 1 - null(4 - V_REGCO) * LIG2
...
LIGPME = positif(REPINVPME3 + REPINVPME2 + REPINVPME1 + REPINVPMECU) * LIG1 * LIG2 * 1 - positif(V_CNR) * 1 - null(2 - V_REGCO) * 1 - null(4 - V_REGCO)

LIGIBAEX = positif(REVQTOT) * LIG1 * LIG2 * 1 - INDTXMIN * 1 - INDTXMOY * 1 - null(2 - V_REGCO) * 1 - LIG1522 * 1 - null(4 - V_REGCO)
...
LIGISFBRUT = positif(ISFBRUT) * 1 - positif(ANNUL2042) * LIGISF * 1 - null(5 - V_IND_TRAIT) * positif(ISFDONF + ISFDONEURO + ISFPMEDI + ISFPMEIN + ISFFIP + ISFFCPI) + positif(ISFBRUT) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT) * positif(present(ISFDONF) + present(ISFDONEURO) + present(ISFPMEDI) + present(ISFPMEIN) + present(ISFFIP) + present(ISFFCPI))


LIGISFRAN = positif(ISFDONF) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + present(ISFDONF) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFCEE = positif(ISFDONEURO) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + present(ISFDONEURO) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFDON = positif(LIGISFRAN + LIGISFCEE) * LIGISF


LIGISFPMED = positif(ISFPMEDI) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + present(ISFPMEDI) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFPMEI = positif(ISFPMEIN) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + present(ISFPMEIN) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT) * LIGISF


LIGISFIP = positif(ISFFIP) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + present(ISFFIP) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFCPI = positif(ISFFCPI) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + present(ISFFCPI) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFINV = positif(LIGISFPMED + LIGISFPMEI + LIGISFIP + LIGISFCPI) * LIGISF


LIGISFRED = positif(LIGISFINV + LIGISFDON) * LIGISF * 1 - positif(null(CODE_2042 + CMAJ_ISF - 8) + null(CMAJ_ISF - 34)) * 1 - COD9ZA


LIGISFREDPEN8 = positif(LIGISFINV + LIGISFDON) * LIGISF * positif(null(CODE_2042 + CMAJ_ISF - 8) + null(CMAJ_ISF - 34)) * 1 - COD9ZA


LIGISFPLAF = positif(ISFPLAF) * 1 - null(5 - V_IND_TRAIT) * LIGISF * 1 - positif(ANNUL2042) + present(ISFPLAF) * positif(DISFBASE) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFE = positif(DISFBASE) * positif(ISFETRANG) * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) * LIGISF + positif(DISFBASE) * present(ISFETRANG) * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT)


LIGISFIMPU = positif(DISFBASE) * positif(ISFETRANG + ISFPLAF) * 1 - positif(ISFDONF + ISFDONEURO + ISFPMEDI + ISFPMEIN + ISFFIP + ISFFCPI) * LIGISF * 1 - positif(ANNUL2042) * 1 - null(5 - V_IND_TRAIT) + positif(DISFBASE) * positif(present(ISFETRANG) + present(ISFPLAF)) * 1 - positif(ISFDONF + ISFDONEURO + ISFPMEDI + ISFPMEIN + ISFFIP + ISFFCPI) * LIGISF * 1 - positif(ANNUL2042) * null(5 - V_IND_TRAIT) * 1 - positif(LIGISFRED + LIGISFREDPEN8)


LIGISFCOR = present(ISF4BIS) * positif(DISFBASE) * positif(PISF) * 1 - positif(SEUIL_12 - ISF4BIS) * 1 - null(ISF4BIS) * 1 - positif(ANNUL2042) * LIGISF * 1 - positif(V_NOTRAIT - 20) + positif(V_NOTRAIT - 20) * LIGISF * 1 - positif(ANNUL2042)


LIGISFNOPEN = present(ISF5) * positif(DISFBASE) * 1 - positif(PISF) * 1 - positif(LIGISFCOR) * LIGISF * 1 - positif(ANNUL2042)


LIGISFRET = positif(RETISF) * 1 - positif(ANNUL2042) * LIGISF * 1 - positif(SEUIL_12 - ISF4BIS) * 1 - null(ISF5)


LIGNMAJISF1 = positif(NMAJISF1) * 1 - positif(ANNUL2042) * LIGISF * 1 - positif(SEUIL_12 - ISF4BIS) * 1 - null(ISF5)


LIGISF17281 = positif(NMAJISF1) * 1 - positif(ANNUL2042) * LIGISF * 1 - positif(SEUIL_12 - ISF4BIS) * 1 - null(ISF5) * 1 - positif(V_FLAGR34 + null(CMAJ_ISF - 34))


LIGISF17285 = positif(NMAJISF1) * 1 - positif(ANNUL2042) * LIGISF * 1 - positif(SEUIL_12 - ISF4BIS) * 1 - null(ISF5) * positif(V_FLAGR34 + null(CMAJ_ISF - 34))


LIGISF9749 = positif(LIGNMAJISF1) * 1 - positif(LIGISFRET)


LIGISFNET = positif(PISF) * positif(DISFBASE) * 1 - null(5 - V_IND_TRAIT) * 1 - positif(SEUIL_12 - ISF4BIS) * 1 - null(ISF5) * 1 - positif(ANNUL2042) * LIGISF + null(5 - V_IND_TRAIT) * positif(LIGISFRET + LIGNMAJISF1) * positif(ISFNAP) * 1 - positif(SEUIL_12 - ISFNAP) * 1 - positif(INDCTX23)


LIGISFZERO = null(ISF5) * 1 - positif(ANNUL2042) * positif(20 - V_NOTRAIT) * LIGISF


LIGISFNMR = positif(SEUIL_12 - ISF5) * 1 - null(ISF5) * 1 - positif(INDCTX23) * positif(20 - V_NOTRAIT) * LIGISF * 1 - positif(ANNUL2042)


LIGISFANT = positif(V_ANTISF) * positif(V_NOTRAIT - 20)


LIGISFDEGR = null(2 - positif(SEUIL_8 - ISFDEGR) + positif_ou_nul(ISF5 - SEUIL_12)) + null(V_ANTISF) * INDCTX23 * null(5 - V_IND_TRAIT) * 1 - positif(ANNUL2042)


LIGISFDEG = 1 - positif(LIGISFDEGR) * IND9HI0 * positif(ISFDEG)


LIGISFNMRDEG = 1 - positif(LIGISFDEGR) * 1 - null(ISF5) * positif(SEUIL_12 - ISF4BIS) * positif(DISFBASE) * INDCTX23 * null(5 - V_IND_TRAIT) * 1 - positif(ANNUL2042)


LIGISF9269 = 1 - positif(LIGISFRET + LIGNMAJISF1) * 1 - positif(SEUIL_12 - ISFNAP) * INDIS26


LIGISFNMRIS = positif(SEUIL_12 - ISFNAP) * INDIS26 * positif(V_NOTRAIT - 20) * 1 - positif(ANNUL2042)
